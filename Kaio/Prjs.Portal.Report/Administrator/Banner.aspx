<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Banner.aspx.vb" Inherits="Prjs.Portal.Report.Administrator_Banner"  ValidateRequest="false"%>
            ...
            <div class="menucontent">
                <div class="top">
                    <ul>
                        ...
                        <li class="liselected">
                            <asp:Label ID="lblAdministratorChannel" runat="server"><a href="../Administrator/Index.aspx?channel=2ba3a3fd0d3773d2d02cadbc708f7a3d" target="_parent" style="color: #377F44">
