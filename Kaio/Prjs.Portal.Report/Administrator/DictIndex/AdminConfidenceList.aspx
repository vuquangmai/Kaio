<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminConfidenceList.aspx.vb" Inherits="Prjs.Portal.Report.AdminConfidenceList" %>
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MỨC TÍN NHIỆM">
                            <ItemStyle Width="30%" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Confidence_Text")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="MÃ TÍN NHIỆM">
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                            <ItemTemplate>
                                    <asp:Label ID="lblService_Code" runat="server" CssClass="label"       Font-Bold="true"                            >
                                <%# DataBinder.Eval(Container.DataItem, "Confidence_Code")%>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='AdminConfidenceEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
