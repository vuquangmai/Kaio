<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminCooperateModelList.aspx.vb" Inherits="Prjs.Portal.Report.AdminCooperateModelList" %>
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MÔ HÌNH HỢP TÁC">
                            <ItemStyle Width="30%" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Model_Text")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="MÃ MÔ HÌNH">
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                            <ItemTemplate>
                                    <asp:Label ID="lblService_Code" runat="server" CssClass="label"       Font-Bold="true"                            >
                                <%# DataBinder.Eval(Container.DataItem, "Model_Code")%>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='AdminCooperateModelEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
