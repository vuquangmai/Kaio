Public Class AdminCooperateModelList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "MÔ HÌNH HỢP TÁC VỚI ĐỐI TÁC"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData()
        Dim sql As String = "SELECT  A.Id, A.Model_Text, A.Model_Code , A.Description " & _
             " From System_Cooperation_Model A" & _
             "  Order by Model_Text "
...
#Region "Delete Data"
    Sub DelData(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        ...
        Dim sql As String = "Delete From System_Cooperation_Model Where Id=" & CType(e.CommandArgument, Integer)
        Try
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._Admin.AdminCooperateModelEdit)
    End Sub
#End Region
