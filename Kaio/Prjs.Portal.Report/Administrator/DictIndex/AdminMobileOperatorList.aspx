<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminMobileOperatorList.aspx.vb" Inherits="Prjs.Portal.Report.AdminMobileOperatorList" %>
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="TÊN MẠNG">
                            <ItemStyle Width="20%" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Mobile_Operator_Text")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="TÊN VIẾT TẮT">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                    <asp:Label ID="lblMobile_Operator_Code" runat="server" CssClass="label"       Font-Bold="true"                            >
                                <%# DataBinder.Eval(Container.DataItem, "Mobile_Operator_Code")%>
                        ...
                        <asp:TemplateColumn HeaderText="MÃ SỐ THUẾ">
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Tax_Code")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='AdminMobileOperatorEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
