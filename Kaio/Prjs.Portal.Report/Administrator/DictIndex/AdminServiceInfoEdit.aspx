<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminServiceInfoEdit.aspx.vb" Inherits="Prjs.Portal.Report.AdminServiceInfoEdit" %>
                ...
                <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="30%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Tên dịch vụ:</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtService_Code" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="50%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
