<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminServiceInfoList.aspx.vb" Inherits="Prjs.Portal.Report.AdminServiceInfoList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="TÊN DỊCH VỤ">
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Service_Text")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='AdminServiceInfoEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
