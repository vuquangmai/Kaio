<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminGroupUserEdit.aspx.vb" Inherits="Prjs.Portal.Report.AdminGroupUserEdit" %>
                ...
                <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Tên nhóm:</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="DropDownListDept_Id" runat="server" CssClass="droplist">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label15" runat="server" CssClass="label">Kênh truy cập:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:CheckBoxList ID="CheckBoxListChannel" runat="server" CssClass="checkbox" RepeatColumns="4">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
