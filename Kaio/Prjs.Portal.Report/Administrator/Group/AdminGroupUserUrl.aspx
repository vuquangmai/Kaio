<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminGroupUserUrl.aspx.vb" Inherits="Prjs.Portal.Report.AdminGroupUserUrl" %>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            <td width="45%" align="left">
                                <asp:Label ID="Label1" runat="server" CssClass="label_title_treeview">» Menu chức năng đang sử dụng</asp:Label>
                            </td>
                            <td>
                            </td>
                            <td width="45%" align="left">
                                <asp:Label ID="Label2" runat="server" CssClass="label_title_treeview">» Menu chức năng chưa được sử dụng</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" align="left">
                                <telerik:RadTreeView runat="server" ID="RadTreeViewUrlActive" DataFieldID="ID"
                                    ...
                                    <DataBindings>
                                        <telerik:RadTreeNodeBinding TextField="Url_Text" ValueField="ID" />
                                    </DataBindings>
