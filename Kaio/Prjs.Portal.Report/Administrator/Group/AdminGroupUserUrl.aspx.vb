...
Public Class AdminGroupUserUrl
    Inherits GlobalPage
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "QUẢN LÝ QUYỀN TRUY CẬP NHÓM ACCOUNT"
...
#Region "Bind DictIndex"
    Private Sub BindGroupName(ByVal GroupId As Integer)
        ...
        End If
    End Sub
    Private Sub BindActive(ByVal GroupId As Integer)
        Try
            Dim dt As DataTable = ObjDataTable.UrlManager.UrlActiveByGroup(GroupId)
            If dt.Rows.Count > 0 Then
        ...
        End Try
    End Sub
    Private Sub BindDeactive(ByVal GroupId As Integer)
        Try
            Dim dt As DataTable = ObjDataTable.UrlManager.UrlDeActiveByGroup(GroupId, CurrentUser.GroupId, CurrentUser.GroupIsAdmin)
            If dt.Rows.Count > 0 Then
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        For Each Node In RadTreeViewUrlDeactive.CheckedNodes
            NodeId = Node.Value
            If NodeId <> "" Then
                str = UpdateObject.UrlManager.InsertUrlGroup(ViewState(ViewStateInfo.Object_Id), NodeId)
            End If
            If str = "" Then
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCancel.Click
        ...
        For Each node In RadTreeViewUrlActive.CheckedNodes
            nodeId = node.Value
            If nodeId <> "" Then
                str = DeleteObject.UrlManager.DeleteGroupUrl(ViewState(ViewStateInfo.Object_Id), nodeId)
            End If
            If str = "" Then
                Me.lblErorr2.Text = Constants.AlertInfo.ExcuteSuccess
            Else
