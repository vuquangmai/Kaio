<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Menuleft.aspx.vb" Inherits="Prjs.Portal.Report.Administrator_Menuleft"  ValidateRequest="false" %>
       ...
       <telerik:RadTreeView ID="RadMenuList" runat="server" DataFieldID="ID" 
                    ...
                    <DataBindings>
                        ...
                        <telerik:RadTreeNodeBinding Depth="1" NavigateUrlField="Url_Id" Target="contentFrame"  TextField="Url_Text" />
                         <telerik:RadTreeNodeBinding Depth="2" NavigateUrlField="Url_Id" Target="contentFrame"                  TextField="Url_Text"  />
                    </DataBindings>
