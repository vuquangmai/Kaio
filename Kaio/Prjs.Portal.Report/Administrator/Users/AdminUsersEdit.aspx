<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminUsersEdit.aspx.vb" Inherits="Prjs.Portal.Report.AdminUsersEdit" %>
                ...
                <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label17" runat="server" CssClass="label">Tên đăng nhập:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtUser_Name" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="50%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Họ tên:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtFull_Name" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="50%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label13" runat="server" CssClass="label">Nhóm:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:DropDownList ID="DropDownListGroup_Id" runat="server" CssClass="droplist">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label15" runat="server" CssClass="label">Email:</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label19" runat="server" CssClass="label">Điện thoại:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtTelephone" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
