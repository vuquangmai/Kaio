<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdminGroupUserList.aspx.vb" Inherits="Prjs.Portal.Report.AdminGroupUserList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Phân quyền truy cập" href='AdminGroupUserUrl.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID"))%>'>
                                    <img border="0" src="../../Images/options-icon_16.png">
                                </a>
                            </ItemTemplate>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Phân quyền chức năng" href='AdminGroupUserPrivilege.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
                                    <img border="0" src="../../Images/controls.gif">
                                </a>
                            </ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="MÃ PHÒNG BAN">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="NGƯỜI TẠO">
                            ...
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "Create_By_Text")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='AdminGroupUserEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
