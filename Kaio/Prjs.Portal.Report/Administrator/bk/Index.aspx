<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Index.aspx.vb" Inherits="Prjs.Portal.Report.Administrator_Index" %>
...
<frameset framespacing="0" border="0" frameborder="no" rows="55,*,20" name="MainFrame">
		...
		<frameset id="frameset1"  framespacing="0" border="1" frameborder="no" cols="165,12,*"  bordercolor =blue  >
	...
	<frame scrolling="no" noresize="noresize" marginheight="0" marginwidth="0" name="menuLeftFrame"  src="MenuLeftFooter.aspx"   >
		</frameset>
            <frameset framespacing="0" border="0" frameborder="no" rows="*,20">
	 <frame scrolling="no" noresize="noresize" marginheight="0" marginwidth="0" name="SplitOutFrame"  src="SplitOut.aspx"   >
	<frame scrolling="no" noresize="noresize" marginheight="0" marginwidth="0" name="SplitOutFooterFrame"  src="SplitOutFooter.aspx"   >
		</frameset>
