    ...
    <form id="form1" runat="server">
        ...
        <div id="HQ">
                        ...
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="DropDownListYear" runat="server" CssClass="droplist" AutoPostBack="True">
            ...
            <div class="datagrid">
                ...
                <telerik:RadGrid ID="RadGrid" runat="server" Width="100%" ShowStatusBar="true" StatusBarSettings-ReadyText="VMG Media Corp"
