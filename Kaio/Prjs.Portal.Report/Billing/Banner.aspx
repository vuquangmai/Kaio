<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Banner.aspx.vb" Inherits="Prjs.Portal.Report.Billing_Banner" %>
                ...
                <div class="top">
                    <ul>
                        ...
                        <li>
                           ...
                           <li class="liselected">
                                <asp:Label ID="lblBillingChannel" runat="server"><a href="../Billing/Index.aspx?channel=841db316461eb28b0e62f687caeb744c" target="_parent" style="color: #377F44">
