<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilBrandInitDataList.aspx.vb" Inherits="Prjs.Portal.Report.BilBrandInitDataList" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="AjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="txtPartner_Text">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="DataGrid" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="txtAccount_Report">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="DataGrid" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <div id="HQ">
            ...
            <div class="input" style="width: 60%">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label27" runat="server" CssClass="label">Tên đối tác:</asp:Label>
                        </td>
                        <td align="left">
                                <asp:TextBox ID="txtPartner_Text" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Width="100%" AutoPostBack="True"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label28" runat="server" CssClass="label">Account:</asp:Label>
                        </td>
                        <td align="left">
                                <asp:TextBox ID="txtAccount_Report" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Width="20%" AutoPostBack="True"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">&nbsp;</td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="ĐỐI TÁC">
                          ...
                          <asp:TemplateColumn HeaderText="ACCOUNT">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblAccount_Report" runat="server" CssClass="label" ForeColor="Red">   <%# DataBinder.Eval(Container.DataItem, "Account_Report")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="DOANH THU">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblHave_Revenue" runat="server" CssClass="label" Font-Bold="true">   <%# DataBinder.Eval(Container.DataItem, "Have_Revenue")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='BilBrandInitDataEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
