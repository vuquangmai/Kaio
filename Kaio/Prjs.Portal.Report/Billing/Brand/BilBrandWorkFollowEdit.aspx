<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilBrandWorkFollowEdit.aspx.vb" Inherits="Prjs.Portal.Report.BilBrandWorkFollowEdit" %>
                ...
                <fieldset id="fieldset1">
                    ...
                    <table border="0" cellpadding="3" cellspacing="2" style="width: 100%">
                        <tr>
                            ...
                            <td align="left">
                                <asp:Label ID="lblTask_Text_Curent" runat="server" CssClass="label" Font-Bold="False" ForeColor="Red"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="left">
                                <asp:Label ID="lblDept_Text_Execute_Current" runat="server" CssClass="label" Font-Bold="False"></asp:Label>
                            </td>
                            <td align="right">
                    ...
                    <fieldset id="fieldset4">
                        ...
                        <table border="0" cellpadding="3" cellspacing="2" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="DropDownListTask" runat="server" AutoPostBack="True" CssClass="droplist" ForeColor="Blue">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                    ...
                    <fieldset id="fieldset2">
                        ...
                        <table border="0" cellpadding="3" cellspacing="2" style="width: 100%">
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Label ID="lblTask_Text_Next_Auto" runat="server" CssClass="label" Font-Bold="False" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td align="left">
                                    <asp:Label ID="lblDept_Text_Execute_Next_Auto" runat="server" CssClass="label" Font-Bold="False"></asp:Label>
                                </td>
                                <td align="right">&nbsp;</td>
                                <td align="left">
                    ...
                    <fieldset id="fieldset5">
                        ...
                        <table border="0" cellpadding="3" cellspacing="2" style="width: 100%">
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Label ID="lblTask_Text_Next_Manual" runat="server" CssClass="label" Font-Bold="False" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td align="left">
                                    <asp:Label ID="lblDept_Text_Execute_Next_Manual" runat="server" CssClass="label" Font-Bold="False"></asp:Label>
                                </td>
                                <td align="right">&nbsp;</td>
                                <td align="left">
