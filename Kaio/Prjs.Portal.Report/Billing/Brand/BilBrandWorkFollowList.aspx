<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilBrandWorkFollowList.aspx.vb" Inherits="Prjs.Portal.Report.BilBrandWorkFollowList" %>
        ...
        <div id="HQ">
            ...
            <div class="input" style="width: 90%">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="DropDownListTypeOfPartner" runat="server" CssClass="droplist" Font-Bold="False">
                                ...
                                <asp:ListItem Value="DL">Đại lý</asp:ListItem>
                                <asp:ListItem Value="KHL">Khách hàng lẻ</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label35" runat="server" CssClass="label">Khoảng doanh thu:</asp:Label>
                        </td>
                        <td align="left">
                            <table cellpadding="0" cellspacing="0" class="auto-style1">
                                <tr>
                                    <td width="10%">
                            <asp:DropDownList ID="DropDownListTotal_Revenue" runat="server" CssClass="droplist">
                                ...
                                <asp:ListItem Value="&lt;=">&lt;=</asp:ListItem>
                                    ...
                                    <td>
                            <asp:TextBox ID="txtTotal_Revenue" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Width="30%"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" AllowMultiColumnSorting="True">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="HỢP ĐỒNG" SortExpression="Contract_Code">
                                ...
                                <ItemStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblContract_Code_1" Text='<%# Eval("Contract_Code")%>' CssClass="label"></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="ĐỐI TÁC" SortExpression="Partner_Text">
                              ...
                              <telerik:GridTemplateColumn HeaderText="ACCOUNT" SortExpression="Partner_Text">
                                <HeaderStyle Width="5%" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblAccount_Report_1"  ForeColor="Red" Text='<%# Eval("Account_Report")%>' CssClass="label"></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="#">
                                ...
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblDept_Id_Execute_Current_1" Visible='<%# SetVisiblIcon(Eval("Dept_Id_Execute_Current"))%>' CssClass="label">
                                                          <a class="datagridLinks" href='BilBrandWorkFollowEdit.aspx?objid=<%#Utils.EncryptText(Eval("ID")) %>'
