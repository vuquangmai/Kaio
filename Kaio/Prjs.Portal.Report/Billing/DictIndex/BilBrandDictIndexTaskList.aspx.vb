Public Class BilBrandDictIndexTaskList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "DANH MỤC CÔNG ĐOẠN ĐỐI SOÁT DỊCH VỤ SMS BRAND"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT  A.Id, A.Task_Order, A.Task_Name, A.Hour_Implement, A.Day_Implement,A.Dept_Id_Execute,A.Dept_Text_Execute,A.Create_By_Text,A.Create_Time,A.Update_By_Text,A.Update_Time, A.Description, " & _
             " Status= case A.Status when 1 then N'Active' else N'Locked' end, B.Dept_Code,B.Dept_Text," & _
             " Row_Number() Over ( Order by Task_Order ) as RowNumber " & _
             " From Billing_Brand_DictIndex_Task A  Inner Join System_Department B On A.Dept_Id_Execute=B.Id"
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._Billing.BilBrandDictIndexTaskEdit)
    End Sub
#End Region
End Class