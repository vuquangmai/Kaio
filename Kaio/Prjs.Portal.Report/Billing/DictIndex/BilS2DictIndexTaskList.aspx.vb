Public Class BilS2DictIndexTaskList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "DANH MỤC CÔNG ĐOẠN ĐỐI SOÁT DỊCH VỤ S2"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT  A.Id, A.Task_Order, A.Task_Name, A.Hour_Implement, A.Day_Implement,A.Dept_Id_Execute,A.Dept_Text_Execute,A.Dept_Id_Biz,A.Dept_Text_Biz,A.Create_By_Text,A.Create_Time,A.Update_By_Text,A.Update_Time, A.Description, " & _
             ...
             " From Billing_S2_DictIndex_Task A  "
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._Billing.BilS2DictIndexTaskEdit)
    End Sub
#End Region
End Class