<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilScratchCardDictIndexTaskEdit.aspx.vb" Inherits="Prjs.Portal.Report.BilScratchCardDictIndexTaskEdit" %>
            ...
            <div class="input" style="width: 90%">
                <table border="0" cellpadding="3" cellspacing="3" style="width: 100%">
                    <tr>
                        ...
                        <td align="left">
                            <asp:CheckBoxList ID="CheckBoxListDept_Id_Biz" runat="server" CssClass="checkbox" Font-Bold="True" RepeatColumns="8" RepeatDirection="Horizontal">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <asp:CheckBoxList ID="CheckBoxListDept_Id_Execute" runat="server" CssClass="checkbox" Font-Bold="True" RepeatColumns="8" RepeatDirection="Horizontal">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="DropDownListTask_Order" runat="server" CssClass="droplist" Font-Bold="False">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
