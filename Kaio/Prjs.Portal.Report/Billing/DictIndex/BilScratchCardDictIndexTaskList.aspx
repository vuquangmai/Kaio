<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilScratchCardDictIndexTaskList.aspx.vb" Inherits="Prjs.Portal.Report.BilScratchCardDictIndexTaskList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="NGÀY T/H">
                         ...
                         <asp:TemplateColumn HeaderText="GIỜ T/H">
                           ...
                           <asp:TemplateColumn HeaderText="THỰC HIỆN">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDept_Code" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Dept_Text_Execute")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='BilScratchCardDictIndexTaskEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
