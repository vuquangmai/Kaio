        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "THÔNG TIN HỢP ĐỒNG, TIẾN ĐỘ ĐỐI SOÁT THANH TOÁN - DỊCH VỤ SMS BRAND NAME"
...
#Region "RadGrid Event"
    Private Sub RadGrid_NeedDataSource(ByVal source As Object, ByVal e As GridNeedDataSourceEventArgs) Handles RadGrid.NeedDataSource
        If Not e.IsFromDetailTable Then
            Dim sql As String = "SELECT * FROM Billing_Brand_Work_Follow Where Year=" & ViewState("Year") & " And month= " & ViewState("Month") & " And Contract_Id=" & ViewState(ViewStateInfo.Object_Id)
