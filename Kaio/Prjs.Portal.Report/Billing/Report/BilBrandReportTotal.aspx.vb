    Public Class BilBrandReportTotal
        Inherits GlobalPage
...
#Region "Page load"
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Me.lbltitle.Text = "BÁO CÁO TIẾN ĐỘ ĐỐI SOÁT, THANH TOÁN VỚI ĐỐI TÁC -  DỊCH VỤ SMS BRAND NAME"
            BindDictIndex()
...
#Region "Bind Data"
    Private Sub bindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = " SELECT  Year,Month," & _
               ...
               "SUM(Total_Revenue) Total_Revenue,SUM(Total_Payment) Total_Payment,SUM(Total_Debts) Total_Debts," & _
               " ROW_NUMBER() OVER (order by Year ) as RowNumber ,count(*) vTotal " & _
               " From Billing_Brand_Work_Follow Where Year =" & Me.DropDownListYear.SelectedItem.Value
        ...
        If strAction = Constants.Action.Search Then
            ...
            End If
        Else
            ExportData.ExportExcel._Bil.BilBrandReportTotal(sql, CurrentUser.UserFullName)
