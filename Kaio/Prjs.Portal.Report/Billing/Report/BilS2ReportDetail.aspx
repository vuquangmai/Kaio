<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilS2ReportDetail.aspx.vb" Inherits="Prjs.Portal.Report.BilS2ReportDetail" %>
    ...
    <link href="../../Styles/HQ.css" rel="stylesheet" type="text/css" />
     <script type="text/javascript">
         function IsDetail(contractId,year,month) {
             window.open("BilS2Info.aspx?objid=" + contractId + "&year=" + year + "&month=" + month, "Bil_S2_Info", "location=no,directories=no,left=0,top=0,height=900,width=900,status=no,scrollbars=yes,toolbars=no,menubar=no,resizable=yes");
         }
