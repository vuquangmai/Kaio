<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilScatchCardReportDetail.aspx.vb" Inherits="Prjs.Portal.Report.BilScatchCardReportDetail" %>
    ...
    <link href="../../Styles/HQ.css" rel="stylesheet" type="text/css" />
     <script type="text/javascript">
         function IsDetail(contractId,year,month) {
             window.open("BilScratchCardInfo.aspx?objid=" + contractId + "&year=" + year + "&month=" + month, "Bil_Scratch_Info", "location=no,directories=no,left=0,top=0,height=900,width=900,status=no,scrollbars=yes,toolbars=no,menubar=no,resizable=yes");
         }
