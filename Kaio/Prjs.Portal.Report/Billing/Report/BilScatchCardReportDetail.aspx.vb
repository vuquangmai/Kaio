...
Public Class BilScatchCardReportDetail
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO TIẾN ĐỘ ĐỐI SOÁT, THANH TOÁN VỚI ĐỐI TÁC - DỊCH VỤ THẺ CÀO"
            BindYear()
            BindMonth()
            DeptExe()
            BindPartner()
...
#Region "Submit Click"
    ...
    Protected Sub btnExp_Click(sender As Object, e As EventArgs) Handles btnExp.Click
        ...
        End If
        sql = sql & " ORDER BY Partner_Code"
        ExportData.ExportExcel._Bil.BilScratchReportDetail(sql, CurrentUser.UserFullName)
