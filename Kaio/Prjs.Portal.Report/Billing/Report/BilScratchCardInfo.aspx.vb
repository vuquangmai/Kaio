...
Public Class BilScratchCardInfo
...
#Region "Page Load"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            ViewState("Year") = Util.Encrypt.DecryptText(Util.DefaultObject.IsNothing(Request.QueryString("year")))
            ViewState("Month") = Util.Encrypt.DecryptText(Util.DefaultObject.IsNothing(Request.QueryString("month")))
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "THÔNG TIN HỢP ĐỒNG, TIẾN ĐỘ ĐỐI SOÁT THANH TOÁN - DỊCH VỤ THẺ CÀO"
...
#End Region
#Region "BindData"
    Private Sub bindData(ByVal ContractId As Integer)
        Dim sql As String = "SELECT * FROM Ccare_Management_Contract Where Id=" & ContractId
...
#Region "RadGrid Event"
    Private Sub RadGrid_NeedDataSource(ByVal source As Object, ByVal e As GridNeedDataSourceEventArgs) Handles RadGrid.NeedDataSource
        If Not e.IsFromDetailTable Then
            Dim sql As String = "SELECT * FROM Billing_ScratchCard_Work_Follow Where Year=" & ViewState("Year") & " And month= " & ViewState("Month") & " And Contract_Id=" & ViewState(ViewStateInfo.Object_Id)
            ...
            Else
                ...
                Me.lblerror.Text = "Không có dữ liệu đối soát thanh toán !"
            End If
        End If
    End Sub
