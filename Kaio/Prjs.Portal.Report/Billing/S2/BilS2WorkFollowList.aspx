<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilS2WorkFollowList.aspx.vb" Inherits="Prjs.Portal.Report.BilS2WorkFollowList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function IsDetail(contractId, year, month) {
            window.open("../../SubscriptionService/DictIndex/S2ContractInfo.aspx?objid=" + contractId + "&year=" + year + "&month=" + month, "Bil_S2_Info", "location=no,directories=no,left=0,top=0,height=900,width=1000,status=no,scrollbars=yes,toolbars=no,menubar=no,resizable=yes");
        }
                            ...
                            <telerik:GridTemplateColumn HeaderText="#">
                                ...
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblDept_Id_Execute_Current_1" Visible='<%# SetVisiblIcon(Eval("Dept_Id_Execute_Current"))%>' CssClass="label">
                                                          <a class="datagridLinks" href='BilS2WorkFollowEdit.aspx?objid=<%#Utils.EncryptText(Eval("ID")) %>'
