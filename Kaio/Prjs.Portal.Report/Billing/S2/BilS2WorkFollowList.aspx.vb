...
Public Class BilS2WorkFollowList
    Inherits GlobalPage
...
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "QUẢN LÝ THÔNG TIN TIẾN ĐỘ ĐỐI SOÁT, THANH TOÁN VỚI ĐỐI TÁC - DỊCH VỤ S2"
            BindYear()
            BindMonth()
            BindPartner()
            DeptExe()
...
#Region "Submit Click"
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnExp.Click
        ...
        End If
        sql = sql & " ORDER BY Partner_Code"
        ExportData.ExportExcel._Bil.BilS2WorkFollowList(sql, CurrentUser.UserFullName)
