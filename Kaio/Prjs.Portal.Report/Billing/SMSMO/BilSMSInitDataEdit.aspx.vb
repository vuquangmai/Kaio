...
Public Class BilSMSInitDataEdit
    Inherits GlobalPage
#Region "Page Load"
        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "SỬA ĐỔI THÔNG TIN ĐỐI SOÁT ĐỐI TÁC - DỊCH VỤ SMS MO"
...
#Region "Bind Data"
    Private Sub bindData(ByVal intId As Integer)
        ...
        If dt.Rows.Count > 0 Then
            ...
            Me.lblRatio_Payment_1.Text = dt.Rows(0).Item("Ratio_Payment_1")
            Me.txtTotal_Payment_2.Text = dt.Rows(0).Item("Total_Payment_2")
            Me.lblRatio_Payment_2.Text = dt.Rows(0).Item("Ratio_Payment_2")
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        If ViewState(ViewStateInfo.Status) = Constants.Action.Update Then
            sql = "Select * From Billing_SMS_DictIndex_Task Where Task_End=1"
            Dim dt As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString(MSSQLConnectionStringGlobal), sql)
            ...
            sql = "Update Billing_SMS_Work_Follow Set Have_Revenue=N'" & Have_Revenue & "'," & _
        ...
        Try
            ...
            RedirectUrl(Constants.Url._Billing.BilSMSInitDataList)
