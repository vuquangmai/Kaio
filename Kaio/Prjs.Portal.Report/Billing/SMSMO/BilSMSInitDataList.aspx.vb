...
Public Class BilSMSInitDataList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "KHỞI TẠO DỮ LIỆU ĐỐI SOÁT THEO HỢP ĐỒNG -  DỊCH VỤ SMS MO"
            BindYear()
            BindMonth()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT A.Id, A.Year, A.Month, A.Contract_Id, A.Contract_Code, A.Partner_Id,A.Partner_Text,A.Partner_Code,A.Account_Report, " & _
             ...
             " From Billing_SMS_Work_Follow  A  " & _
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        If Me.CheckBoxDel.Checked = True Then
            sql = "Delete  From  Billing_SMS_Work_Follow  Where   Year =" & Year & " And Month=" & Month
            Try
            ...
            Catch ex As Exception
                ...
                Exit Sub
            End Try
            sql = "Delete  From  Billing_SMS_Work_Follow_Detail  Where   Year =" & Year & " And Month=" & Month
            Try
                MSSQLEnv.ExecuteNonQuery.sqlText(IsSqlConnection.BuildSqlConnectionString(MSSQLConnectionStringGlobal), sql)
            Catch ex As Exception
                Me.lblerror.Text = "Lỗi xóa dữ liệu cũ. Mã lỗi: " & ex.Message
            ...
            End Try
        End If
        sql = "SELECT  SUM(Hour_Implement) TotalHour_Implement,SUM(Day_Implement) TotalDay_Implement, COUNT(*) Total_Task FROM   Billing_SMS_DictIndex_Task "
        ...
        sql = "Select * From Billing_SMS_DictIndex_Task Where Task_Order=1"
        ...
        Else
            ...
            Exit Sub
        End If
        sql = "Select * From Billing_SMS_DictIndex_Task Where Task_Order=2"
        ...
        sql = "SELECT A.Id,A.TypeOfPartner,A.Department_Id,A.Department_Text,A.Contract_Code,A.Contract_Number,A.Cycle_Contract_Text, A.Contract_Text,Isnull(A.Account_Report,'') Account_Report," & _
            ...
            " WHERE A.Contract_Status=1 And  A.Service_Id=" & Constants.ServiceInfo.Id.SMS & _
...
#Region "Init Data"
    Private Function InitData(ByVal Year As Integer, _
        ...
        With cmd
            ...
            .CommandText = "Billing_SMS_Work_Follow_Init_Data"
