<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilSMSWorkFollowList.aspx.vb" Inherits="Prjs.Portal.Report.BilSMSWorkFollowList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function IsDetail(contractId, year, month) {
            window.open("../../SMS/DictIndex/SMSContractInfo.aspx?objid=" + contractId + "&year=" + year + "&month=" + month, "Bil_SMS_Info", "location=no,directories=no,left=0,top=0,height=900,width=1000,status=no,scrollbars=yes,toolbars=no,menubar=no,resizable=yes");
        }
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" AllowMultiColumnSorting="True">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="#">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblDept_Id_Execute_Current_1" Visible='<%# SetVisiblIcon(Eval("Multi_Dept_Execute"), Eval("Dept_Id_Execute_Current"), Eval("Dept_Id_Of"))%>' CssClass="label">
                                                          <a class="datagridLinks" href='BilSMSWorkFollowEdit.aspx?objid=<%#Utils.EncryptText(Eval("ID")) %>'
