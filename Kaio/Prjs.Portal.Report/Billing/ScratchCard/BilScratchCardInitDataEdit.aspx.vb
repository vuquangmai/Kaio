...
Public Class BilScratchCardInitDataEdit
    Inherits GlobalPage
#Region "Page Load"
        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "SỬA ĐỔI THÔNG TIN ĐỐI SOÁT ĐỐI TÁC - DỊCH VỤ THẺ CÀO"
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        If ViewState(ViewStateInfo.Status) = Constants.Action.Update Then
            sql = "Select * From Billing_ScratchCard_DictIndex_Task Where Task_End=1"
            Dim dt As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString(MSSQLConnectionStringGlobal), sql)
            ...
            sql = "Update Billing_ScratchCard_Work_Follow Set Have_Revenue=N'" & Have_Revenue & "'," & _
        ...
        Try
            ...
            RedirectUrl(Constants.Url._Billing.BilScratchCardInitDataList)
