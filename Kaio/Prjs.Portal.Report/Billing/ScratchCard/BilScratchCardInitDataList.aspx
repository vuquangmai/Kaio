<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilScratchCardInitDataList.aspx.vb" Inherits="Prjs.Portal.Report.BilScratchCardInitDataList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='BilScratchCardInitDataEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
