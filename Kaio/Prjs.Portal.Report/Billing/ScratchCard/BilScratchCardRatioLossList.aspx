<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BilScratchCardRatioLossList.aspx.vb" Inherits="Prjs.Portal.Report.BilScratchCardRatioLossList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="THÁNG">
                          ...
                          <asp:TemplateColumn HeaderText="CHU KỲ">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="lblCycle_Number" runat="server" CssClass="label" Font-Bold="true">   <%# DataBinder.Eval(Container.DataItem, "Cycle_Number")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                     <asp:TemplateColumn HeaderText="TỶ LỆ">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="lblRatio_Percent_Loss" runat="server" CssClass="label" Font-Bold="true" ForeColor="#ff0000">   <%# DataBinder.Eval(Container.DataItem, "Ratio_Percent_Loss")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='BilScratchCardRatioLossEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
