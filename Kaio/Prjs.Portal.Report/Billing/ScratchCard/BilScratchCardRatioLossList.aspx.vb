Public Class BilScratchCardRatioLossList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "TỶ LỆ THẤT THOÁT DỊCH VỤ VỤ THẺ CÀO"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT  A.Id, A.Month, A.Mobile_Operator, A.Cycle_Number, A.Ratio_Percent_Loss,A.Create_By_Id,A.Create_By_Text,A.Create_Time,A.Update_By_Id,A.Update_By_Text,A.Update_Time,A.Description," & _
             " Row_Number() Over ( Order by Month desc ) as RowNumber " & _
             " From Billing_ScratchCard_Ratio_Loss A  "
        ...
        If dt.Rows.Count > 0 Then
            ...
            Me.DataGrid.Columns(9).Visible = IsDelete
...
#Region "Delete Data"
    Sub DelData(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        Dim sql As String = "Delete  From  Billing_ScratchCard_Ratio_Loss  Where  Id =" & CType(e.CommandArgument, Integer)
        Try
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._Billing.BilScratchCardRatioLossEdit)
    End Sub
#End Region
End Class