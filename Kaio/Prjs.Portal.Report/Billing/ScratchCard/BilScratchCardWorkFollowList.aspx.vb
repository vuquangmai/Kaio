...
Public Class BilScratchCardWorkFollowList
    Inherits GlobalPage
...
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "QUẢN LÝ THÔNG TIN TIẾN ĐỘ ĐỐI SOÁT, THANH TOÁN VỚI ĐỐI TÁC - DỊCH VỤ THẺ CÀO"
            BindYear()
            BindMonth()
            BindPartner()
            DeptExe()
...
#Region "DictIndex"
    ...
    Private Sub BindPartner()
        ...
        " WHERE B.Service_Id= " & Constants.ServiceInfo.Id.TC
    ...
    Private Sub BindTask()
        Dim sql As String = "SELECT * FROM Billing_ScratchCard_DictIndex_Task  Order by Task_Order "
        Dim dt As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString(MSSQLConnectionStringGlobal), sql)
    ...
    End Sub
    Private Sub DeptExe()
        Dim sql As String = "SELECT Dept_Id_Execute,Dept_Text_Execute FROM Billing_ScratchCard_DictIndex_Task GROUP BY Dept_Id_Execute,Dept_Text_Execute ORDER BY Dept_Text_Execute"
        Dim dt As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString(MSSQLConnectionStringGlobal), sql)
...
#Region "RadGrid Event"
    Private Sub RadGrid_NeedDataSource(ByVal source As Object, ByVal e As GridNeedDataSourceEventArgs) Handles RadGrid.NeedDataSource
        If Not e.IsFromDetailTable Then
            Dim sql As String = "SELECT * FROM Billing_ScratchCard_Work_Follow " & _
    ...
    Private Sub RadGrid_DetailTableDataBind(ByVal source As Object, ByVal e As GridDetailTableDataBindEventArgs) Handles RadGrid.DetailTableDataBind
        ...
        Select Case e.DetailTableView.Name
            Case "Orders"
                ...
                sql = "SELECT *  FROM Billing_ScratchCard_Work_Follow_Detail  " & _
...
#End Region
#Region "InVisible"
    Public Function SetVisiblIcon(ByVal Dept_Id_Execute_Current As String) As String
