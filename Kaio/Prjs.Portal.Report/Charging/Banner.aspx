<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Banner.aspx.vb" Inherits="Prjs.Portal.Report.Charging_Banner" %>
            ...
            <div class="menucontent">
                <div class="top">
                    <ul>
                        ...
                        <li  >
                            <asp:Label ID="lblCustomerInfoChannel" runat="server"><a href="../CustomerInfo/Index.aspx?channel=97b851381117d8131466b420b991aeeb" target="_parent" >
                                <asp:Label ID="lblCustomerInfo" runat="server"> </asp:Label></a></asp:Label></li>
                           <li class="liselected">
                            <asp:Label ID="lblChargingChannel" runat="server"><a href="../Charging/Index.aspx?channel=2acb068a481d6b561b0b5c803f15230a" target="_parent" style="color: #377F44">
                                <asp:Label ID="lblCharging" runat="server"> </asp:Label></a></asp:Label></li>
                            <li>
