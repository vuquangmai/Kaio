...
#Region "RadGrid Event"
    Private Sub RadGrid_NeedDataSource(ByVal source As Object, ByVal e As GridNeedDataSourceEventArgs) Handles RadGrid.NeedDataSource
        If Not e.IsFromDetailTable Then
            Dim sql As String = "SELECT * FROM Billing_ScratchCard_Work_Follow Where Year=" & ViewState("Year") & " And month= " & ViewState("Month") & " And Contract_Code=N'" & ViewState(ViewStateInfo.Object_Id) & "'"
            ...
            Else
                ...
                Me.lblerror.Text = "Không có dữ liệu tiến độ đối soát, thanh toán !"
            End If
        End If
    End Sub
