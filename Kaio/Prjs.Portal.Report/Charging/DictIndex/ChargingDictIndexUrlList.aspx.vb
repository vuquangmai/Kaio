Public Class ChargingDictIndexUrlList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "QUẢN LÝ TÀI KHOẢN THẺ CÀO"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT  A.Id, A.Partner_Id, A.Url_Code, A.Ratio_After_VIETTEL,A.Ratio_After_VMS, A.Ratio_After_VNP,A.Ratio_After_VNM,A.Ratio_After_GTEL,A.Ratio_After_VMG_VIETTEL,A.Ratio_After_VMG_VMS,A.Ratio_After_VMG_VNP,A.Ratio_After_VMG_VNM,A.Ratio_After_VMG_GTEL,A.Url,A.Create_By_Text,A.Create_Time,A.Update_By_Text,A.Update_Time, A.Description, " & _
             ...
             " Partner_Code= case A.Partner_Id when 0 then N'VMG' else B.Partner_Code end," & _
             " Row_Number() Over ( Order by Partner_Text ) as RowNumber " & _
             " From ScratchCard_DictIndex_Url_Service A  Left Join Ccare_Management_Partner B On A.Partner_Id=B.Id"
...
#Region "Delete Data"
    Sub DelData(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        Dim sql As String = "Delete  From  ScratchCard_DictIndex_Url_Service  Where  Id =" & CType(e.CommandArgument, Integer)
        Try
            MSSQLEnv.ExecuteNonQuery.sqlText(IsSqlConnection.BuildSqlConnectionString(MSSQLConnectionStringGlobal), sql)
            sql = "Delete From Ccare_Management_Contract_ScratchCard Where Url_Id=" & CType(e.CommandArgument, Integer)
            MSSQLEnv.ExecuteNonQuery.sqlText(IsSqlConnection.BuildSqlConnectionString(MSSQLConnectionStringGlobal), sql)
            ViewState("DATA_GRID") = Nothing
            ViewState("DATA_COUNT") = Nothing
            Dim intPageSize As Integer = pager1.PageSize
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._Charging.ChargingDictIndexUrlEdit)
    End Sub
#End Region
End Class