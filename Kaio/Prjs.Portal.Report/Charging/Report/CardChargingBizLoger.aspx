<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CardChargingBizLoger.aspx.vb" Inherits="Prjs.Portal.Report.CardChargingBizLoger" %>
            ...
            <div class="input">
                   <table width="100%">
                                <tr>
                                    ...
                                    <td align="right" width="15%">
                                        <asp:Label ID="lblTrang13" runat="server" CssClass="label">Loại thẻ:</asp:Label>
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:Label ID="lblTrang14" runat="server" CssClass="label">Đối tác:</asp:Label>
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:Label ID="lblTrang15" runat="server" CssClass="label">Mệnh giá  thẻ:</asp:Label>
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:CheckBox ID="CheckBoxAllDate" runat="server" CssClass="checkbox" Text="Cả tháng" />
                                    </td>
                                    <td align="right">
                                        <asp:Label ID="lblTrang16" runat="server" CssClass="label">Serial:</asp:Label>
                                    </td>
                                    <td align="left">
                            <asp:TextBox ID="txtSerial" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        &nbsp;</td>
                                    <td align="right">
                                        <asp:Label ID="lblTrang17" runat="server" CssClass="label">PIN:</asp:Label>
                                    </td>
                                    <td align="left">
                            <asp:TextBox ID="txtPin" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="80%"></asp:TextBox>
                                    </td>
                                </tr>
                                </table>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDepartment_Text" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vUserName")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                       <asp:TemplateColumn HeaderText="ĐỐI TÁC">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblvMonth" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vsubcp_name")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="LOẠI THẺ">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblvDate" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vServiceName")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="THỜI GIAN">
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblvHour" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vTime")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                              <asp:TemplateColumn HeaderText="TRẠNG THÁI">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblvCardName" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vStatus")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="MỆNH GIÁ">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblvStatus" runat="server" CssClass="label" Font-Bold="true">   <%# DataBinder.Eval(Container.DataItem, "vCardAmount")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="SERIAL">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblvCardAmount" runat="server" CssClass="label"  > <%# DataBinder.Eval(Container.DataItem, "vSerial")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="PIN">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblvTotal_Card" runat="server" CssClass="label" >   <%# DataBinder.Eval(Container.DataItem, "vPin")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="MESSAGE">
                            <ItemStyle Width="10%" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:Label ID="lblvTotal_Amount" runat="server" CssClass="label"   >   <%# DataBinder.Eval(Container.DataItem, "vError_Message")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
