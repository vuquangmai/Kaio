    Public Class CardChargingBizMonth
        Inherits GlobalPage
...
#Region "Page load"
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Me.lbltitle.Text = "BÁO CÁO DOANH THU THẺ CÀO TỔNG HỢP THEO NGÀY -  TRUNG TÂM KINH DOANH"
                BindDictIndex()
                InitData()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        ElseIf strAction = Constants.Action.Export Then
            ...
            ExportData.ExportExcel._Charging.ChargingBizMonth(sqlExc, CurrentUser.UserName, _
