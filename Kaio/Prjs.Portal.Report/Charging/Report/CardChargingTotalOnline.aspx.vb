    Public Class CardChargingTotalOnline
        Inherits GlobalPage
...
#Region "Page load"
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Me.lbltitle.Text = "BÁO CÁO DOANH THU THẺ CÀO ONLINE"
                BindDictIndex()
                InitData()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        " if('" & Me.CheckBoxCard_Type.Checked & "' like 'False' ,'--all--', A.ServiceName) vCardName  ," & _
        ...
        " FROM " &
        vTable & _
       " A INNER JOIN subcp B  on A.SubCPId=B.Id "
        ...
        ElseIf strAction = Constants.Action.Export Then
            ...
            ExportData.ExportExcel._Charging.ChargingTotalOnline(sqlExc, _
