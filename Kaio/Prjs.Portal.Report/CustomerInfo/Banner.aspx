<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Banner.aspx.vb" Inherits="Prjs.Portal.Report.CustomerInfo_Banner" %>
            ...
            <div class="menucontent">
                <div class="top">
                    <ul>
                        ...
                        <li class="liselected">
                            <asp:Label ID="lblCustomerInfoChannel" runat="server"><a href="../CustomerInfo/Index.aspx?channel=97b851381117d8131466b420b991aeeb" target="_parent" style="color: #377F44">
