<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CCareImportUser.aspx.vb" Inherits="Prjs.Portal.Report.CCareImportUser" %>
                   ...
                   <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td align="left" class="auto-style3" colspan="2">
                                ...
                                <asp:CheckBoxList ID="CheckBoxListFIELD_ID" runat="server" CssClass="checkbox" RepeatColumns="6">
                                </asp:CheckBoxList>

                            </td>
                            <td align="left" class="auto-style3">
                                <asp:CheckBox ID="CheckBoxDelData" runat="server" CssClass="checkbox" Text="Xóa dữ liệu cũ?" />
                            </td>
                        </tr>
                        ...
                        <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="TỔNG">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotal" runat="server" CssClass="label" Font-Bold="true" ForeColor="Blue"> <%# Utils_1.FormatDecimal(DataBinder.Eval(Container.DataItem, "Total"), 0)%></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="deleter" runat="server" title="Xóa" BorderStyle="None"
                                            CausesValidation="False" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "KEY_IMPORT")%>'
