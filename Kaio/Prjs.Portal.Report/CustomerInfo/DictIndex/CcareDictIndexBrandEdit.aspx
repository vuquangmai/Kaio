<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexBrandEdit.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexBrandEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Brand name:</asp:Label>
                        </td>
                        <td align="left">
