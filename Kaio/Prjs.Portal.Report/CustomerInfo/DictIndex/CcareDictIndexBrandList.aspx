<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexBrandList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexBrandList" %>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Brand:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtBRAND_NAME" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexBrandEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
