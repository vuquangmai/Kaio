<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexCareerEdit.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexCareerEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Ngành nghề:</asp:Label>
                        </td>
                        <td align="left">
