<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexDistrictEdit.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexDistrictEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label15" runat="server" CssClass="label">Tỉnh/Thành:</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Quận/Huyện:</asp:Label>
                        </td>
                        <td align="left">
