<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexDistrictList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexDistrictList" %>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                <tr>
                                    <td align="right" width="20%">
                                        <asp:Label ID="Label1" runat="server" CssClass="label">Tỉnh/Thành:</asp:Label>
                                    </td>
                                    <td align="left">
                            <asp:DropDownList ID="DropDownListPROVINCE_ID" runat="server" CssClass="droplist">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Quận/Huyện:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtDISTRICT_TEXT" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexDistrictEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
