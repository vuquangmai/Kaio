<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexFeesEdit.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexFeesEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Mức cước:</asp:Label>
                        </td>
                        <td align="left">
