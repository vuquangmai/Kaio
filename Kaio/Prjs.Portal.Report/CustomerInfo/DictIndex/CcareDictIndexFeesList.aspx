<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexFeesList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexFeesList" %>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Mức cước:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtFEES_TEXT" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexFeesEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
