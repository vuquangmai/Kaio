<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexFieldList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexFieldList" %>
                        ...
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtFIELD_TEXT" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="NGÀNH HÀNG">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblSOURCE_TEXT" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "FIELD_TEXT")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexFieldEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
