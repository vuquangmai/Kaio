<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexInComeEdit.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexInComeEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Mức thu nhập:</asp:Label>
                        </td>
                        <td align="left">
