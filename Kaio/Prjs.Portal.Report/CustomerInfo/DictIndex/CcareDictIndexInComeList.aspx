<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexInComeList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexInComeList" %>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Mức thu nhập:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtINCOME_TEXT" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MỨC THU NHẬP">
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexInComeEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
