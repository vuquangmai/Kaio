Public Class CcareDictIndexInComeList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "DANH MỤC MỨC THU NHẬP CỦA KHÁCH HÀNG"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT Id,INCOME_TEXT,Status_Id,Status_Text,Create_By_Id,Create_By_Text,Create_Time,Update_By_Id,Update_By_Text,Update_Time,Description, RowNum as RowNumber " & _
                                     " FROM CCARE_DICTINDEX_INCOME "
        If Me.txtINCOME_TEXT.Text.Trim <> "" Then
            sql = sql & " Where upper(INCOME_TEXT)='" & Me.txtINCOME_TEXT.Text.Trim.ToUpper & "'"
        End If
...
#Region "Delete Data"
    Sub DelData(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        Dim sql As String = "Delete  From  CCARE_DICTINDEX_INCOME  Where  Id =" & CType(e.CommandArgument, Integer)
        Try
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._CcareB2C.CcareDictIndexInComeEdit)
    End Sub
#End Region
End Class