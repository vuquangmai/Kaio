<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexPartnerEdit.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexPartnerEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Mã đối tác:</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label15" runat="server" CssClass="label">Tên đối tác:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtPARTNER_FULL_NAME" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="80%" Font-Bold="True"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
