<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexPartnerList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexPartnerList" %>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Đối tác:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtPARTNER_TEXT" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MÃ ĐỐI TÁC">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblPARTNER_TEXT" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "PARTNER_FULL_NAME")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                           <asp:TemplateColumn HeaderText="TÊN ĐỐI TÁC">
                            <ItemStyle Width="25%" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:Label ID="lblPARTNER_FULL_NAME" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "PARTNER_TEXT")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexPartnerEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
