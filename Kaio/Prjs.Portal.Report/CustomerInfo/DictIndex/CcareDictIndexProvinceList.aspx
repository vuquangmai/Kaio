<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexProvinceList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexProvinceList" %>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <asp:DropDownList ID="DropDownListREGION_ID" runat="server" CssClass="droplist">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Tỉnh thành:</asp:Label>
                                    </td>
                                    <td align="left">
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MIỀN">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblREGION_TEXT" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "REGION_TEXT")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexProvinceEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
