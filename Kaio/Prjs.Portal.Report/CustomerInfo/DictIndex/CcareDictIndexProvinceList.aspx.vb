Public Class CcareDictIndexProvinceList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "DANH MỤC TỈNH THÀNH"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT Id,REGION_ID,REGION_TEXT,PROVINCE_TEXT,Status_Id,Status_Text,Create_By_Id,Create_By_Text,Create_Time,Update_By_Id,Update_By_Text,Update_Time,Description, RowNum as RowNumber " & _
                                     " FROM CCARE_DICTINDEX_PROVINCE "
        If Me.txtPROVINCE_TEXT.Text.Trim <> "" Then
            sql = sql & " Where upper(PROVINCE_TEXT)='" & Me.txtPROVINCE_TEXT.Text.Trim.ToUpper & "'"
        End If
        If Me.DropDownListREGION_ID.SelectedItem.Value > 0 Then
            sql = sql & " AND REGION_ID=" & Me.DropDownListREGION_ID.SelectedItem.Value
        End If
...
#Region "Delete Data"
    Sub DelData(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        Dim sql As String = "Select * From CCARE_DICTINDEX_DISTRICT Where PROVINCE_ID=" & CType(e.CommandArgument, Integer)
        If Me.B2CCheckData(sql) = False Then
            sql = "Delete  From  CCARE_DICTINDEX_PROVINCE  Where  Id =" & CType(e.CommandArgument, Integer)
            Try
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._CcareB2C.CcareDictIndexProvinceEdit)
    End Sub
