<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexRefuseEdit.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexRefuseEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label7" runat="server" CssClass="label">Số điện thoại:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtUser_Id" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="40%" Font-Bold="True" ForeColor="#0033CC"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
