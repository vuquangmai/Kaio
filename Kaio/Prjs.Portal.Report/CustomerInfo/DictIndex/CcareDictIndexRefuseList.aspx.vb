Public Class CcareDictIndexRefuseList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "DANH SÁCH KHÁCH HÀNG TỪ CHỐI NHẬN TIN QUẢNG CÁO"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        If Me.txtUser_Id.Text.Trim <> "" Then
            sql = sql & " Where USER_ID='" & Me.txtUser_Id.Text.Trim & "'"
        End If
...
#Region "Submit Click"
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect(Constants.Url._CcareB2C.CcareDictIndexRefuseEdit)
    End Sub
