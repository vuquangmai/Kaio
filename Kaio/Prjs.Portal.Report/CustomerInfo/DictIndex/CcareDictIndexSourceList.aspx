<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareDictIndexSourceList.aspx.vb" Inherits="Prjs.Portal.Report.CcareDictIndexSourceList" %>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Nguồn dữ liệu:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtSOURCE_TEXT" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi" href='CcareDictIndexSourceEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
