<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CcareReportUserComplete.aspx.vb" Inherits="Prjs.Portal.Report.CcareReportUserComplete" %>
            ...
            <div class="alert">
               ...
               <div class="parametter" style="width: 90%;">
                <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                        ...
                        <tr>
                            <td align="right" width="15%">
                                <asp:Label ID="Label55" runat="server" CssClass="label">Loại thời gian:</asp:Label>
                            </td>
                            <td align="left" width="35%">
                                <table class="auto-style1">
                                    <tr>
                                        <td width="20%">
                                <asp:DropDownList ID="DropDownListTypeOfTime" runat="server" CssClass="droplist">
                                ...
                                <table cellpadding="0" cellspacing="1" class="auto-style1">
                                    <tr>
                                        ...
                                        <td align="right" width="30%">
                                            <asp:CheckBox ID="CheckBoxDISTRICT_ID" runat="server" CssClass="checkbox" Text="Quận/Huyện:" TextAlign="Left" />
                                        </td>
                                        <td>
                        ...
                        <tr>
                            ...
                            <td align="right"  >
                                            <asp:CheckBox ID="CheckBoxCREATE_BY_TEXT" runat="server" CssClass="checkbox" Text="Khởi tạo:" TextAlign="Left" />
                            </td>
                            <td align="left"  >
                                <asp:DropDownList ID="DropDownListCREATE_BY_TEXT" runat="server" CssClass="droplist">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="right"  >
                                            <asp:CheckBox ID="CheckBoxUPDATE_BY_TEXT" runat="server" CssClass="checkbox" Text="Cập nhật:" TextAlign="Left" />
                            </td>
                            <td align="left"  >
                                <asp:DropDownList ID="DropDownListUPDATE_BY_TEXT" runat="server" CssClass="droplist">
                                </asp:DropDownList>
                            </td>
                        </tr>
            ...
            <div class="submmit">
                 <asp:Button ID="btnSearch" runat="server" CssClass="btnbackground"
                    ...
                    <asp:Button ID="btnExport" runat="server" CssClass="btnbackground"
                        Text="Báo cáo" />
                                            <asp:CheckBox ID="CheckBoxExpUserOnly" runat="server" CssClass="checkbox" Text="Xuất số điện thoại?" Checked="True" />
                                <asp:DropDownList ID="DropDownListFileType" runat="server" CssClass="droplist">
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="SỐ ĐIỆN THOẠI">
                         ...
                         <asp:TemplateColumn HeaderText="QUẬN HUYỆN">
                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                            <ItemTemplate>
                                <asp:Label ID="lblDISTRICT_TEXT" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "DISTRICT_TEXT")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
