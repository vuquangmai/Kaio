Public Class CcareReportVerify
    Inherits GlobalPage
...
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO DỮ LIỆU XỬ LÝ"
            IsPrivilegeOnMenu()
            BindDictIndex()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim vTable As String = "CCARE_CUSTOMER_VERIFY_1"
        ...
        wSQL = " WHERE to_char(" & Me.DropDownListTypeOfTime.SelectedItem.Value & ",'yyyyMMdd') >='" & FromDate & "'"
        ...
        End If
        If Me.CheckBoxCREATE_BY_TEXT.Checked = True And Me.DropDownListCREATE_BY_TEXT.SelectedItem.Value <> "--all--" Then
            wSQL = wSQL & " and CREATE_BY_ID=" & Me.DropDownListCREATE_BY_TEXT.SelectedItem.Value
        End If
        If Me.CheckBoxUPDATE_BY_TEXT.Checked = True And Me.DropDownListUPDATE_BY_TEXT.SelectedItem.Value <> "--all--" Then
