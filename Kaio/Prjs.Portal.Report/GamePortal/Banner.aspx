<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Banner.aspx.vb" Inherits="Prjs.Portal.Report.GamePortal_Banner" %>
            ...
            <div class="menucontent">
                <div class="top">
                    <ul>
                        ...
                        <li class="liselected">
                            <asp:Label ID="lblGamePortalChannel" runat="server"><a href="../GamePortal/Index.aspx?channel=6d4727b02e106f11324048cdc0b14f3b" target="_parent" style="color: #377F44">
