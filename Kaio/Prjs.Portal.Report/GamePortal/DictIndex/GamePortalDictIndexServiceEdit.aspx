<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GamePortalDictIndexServiceEdit.aspx.vb" Inherits="Prjs.Portal.Report.GamePortalDictIndexServiceEdit" %>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="DropDownListChannel_Id" runat="server" CssClass="droplist">
                                <asp:ListItem Value="2">Game Portal</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
