<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VMGameDictIndexServiceList.aspx.vb" Inherits="Prjs.Portal.Report.VMGameDictIndexServiceList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='VMGameDictIndexServiceEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
