Public Class VMGameDictIndexServiceList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "QUẢN LÝ ĐỐI TÁC CUNG CẤP GAME -  DỊCH VỤ VNM GAME"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT  A.Id, A.Partner_Id, A.Url_Code, A.Ratio_Share,A.Channel_Id,A.Channel_Text, A.Url,A.Create_By_Text,A.Create_Time,A.Update_By_Text,A.Update_Time, A.Description, " & _
             ...
             " From GamePortal_DictIndex_Url_Service A  Left Join Ccare_Management_Partner B On A.Partner_Id=B.Id Where A.Channel_Id=1"
