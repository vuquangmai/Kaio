...
Public Class GamePortal_Menuleft
    Inherits GlobalPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            ...
            Dim dt As DataTable = ObjDataTable.UrlManager.UrlByGroupId(CurrentUser.GroupId, CurrentUser.UserId, Constants.Channel.Id.GamePortal)
