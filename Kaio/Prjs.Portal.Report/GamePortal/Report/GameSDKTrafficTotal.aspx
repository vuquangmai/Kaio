<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GameSDKTrafficTotal.aspx.vb" Inherits="Prjs.Portal.Report.GameSDKTrafficTotal" %>
                ...
                <div class="input">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:CheckBox ID="CheckBoxGame_Text" runat="server" CssClass="checkbox" Text="Game:" TextAlign="Left" />
                            </td>
                            <td align="left">
                                <telerik:RadComboBox ID="RadDropDownListGame_Text" runat="server" CheckBoxes="True" EnableCheckAllItemsCheckBox="True" Skin="Hay" Width="90%">
                                    <Items>
                                        <telerik:RadComboBoxItem Text="CS Mobile" Value="CS Mobile" />
                                        <telerik:RadComboBoxItem Text="Bleach" Value="Bleach" />
                                        <telerik:RadComboBoxItem Text="Trà Chanh Quán" Value="Trà Chanh Quán" />
                                        <telerik:RadComboBoxItem Text="Phong Thần" Value="Phong Thần" />
                                        <telerik:RadComboBoxItem Text="Các game khác" Value="Các game khác" />
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="THỨ">
                            ...
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblGame_Text" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Game_Text")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
