...
Public Class GameTCQTrafficTotal
    Inherits GlobalPage
...
#Region "Page load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO DOANH THU GAME CS MOBILE"
            BindDictIndex()
            InitData()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        sqlTotal = "SELECT substring(Date,1,4) as Year,substring(Date,5,2) as Month," & _
                              ...
                              " SUM(cast(Money_VMG_Partner as decimal)) Money_VMG_Partner, SUM(cast(Money_Partner_VMG as decimal)) Money_Partner_VMG " & _
                            " FROM " & vTable
        sqlConditional = sqlConditional & " WHERE Game_Id IN (" & Constants.Game.GameId._TCQ_1 & "," & Constants.Game.GameId._TCQ_1 & ") And Status_Id=" & Me.RadDropDownListStatus_Id.SelectedItem.Value
