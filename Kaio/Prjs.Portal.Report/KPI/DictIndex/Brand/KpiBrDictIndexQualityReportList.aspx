<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiBrDictIndexQualityReportList.aspx.vb" Inherits="Prjs.Portal.Report.KpiBrDictIndexQualityReportList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiBrDictIndexQualityReportEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
