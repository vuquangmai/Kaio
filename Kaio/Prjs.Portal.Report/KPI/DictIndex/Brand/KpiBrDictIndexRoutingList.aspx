<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiBrDictIndexRoutingList.aspx.vb" Inherits="Prjs.Portal.Report.KpiBrDictIndexRoutingList" %>
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MÃ ĐƯỜNG">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="Routing_Id" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Routing_Id")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="TÊN ĐƯỜNG GỬI TIN">
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                            <ItemTemplate>
                                <asp:Label ID="Routing_Text" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Routing_Text")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="TỶ TRỌNG">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="Percentage" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Percentage")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="TRẠNG THÁI">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="Status_Text" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Status_Text")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiBrDictIndexRoutingEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
