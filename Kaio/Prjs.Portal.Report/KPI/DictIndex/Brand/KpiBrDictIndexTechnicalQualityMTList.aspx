<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiBrDictIndexTechnicalQualityMTList.aspx.vb" Inherits="Prjs.Portal.Report.KpiBrDictIndexTechnicalQualityMTList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiBrDictIndexTechnicalQualityMTEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
