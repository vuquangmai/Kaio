<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiBrDictIndexTimeApproveBrandCcareEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiBrDictIndexTimeApproveBrandCcareEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:Label ID="Label26" runat="server" CssClass="label">Giờ</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
