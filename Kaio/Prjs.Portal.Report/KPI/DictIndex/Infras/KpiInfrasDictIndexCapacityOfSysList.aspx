<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexCapacityOfSysList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexCapacityOfSysList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexCapacityOfSysEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
