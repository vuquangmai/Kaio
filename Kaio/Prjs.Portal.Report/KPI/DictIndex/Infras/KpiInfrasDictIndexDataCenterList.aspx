<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexDataCenterList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexDataCenterList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexDataCenterEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
