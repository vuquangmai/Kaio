<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexIntegrityDataEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexIntegrityDataEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblerror2" runat="server" CssClass="lblerror" Font-Italic="True" Font-Underline="True">Khả năng phục hồi dữ liệu khi có sự cố:</asp:Label>
                        </td>
                        <td align="left">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label35" runat="server" CssClass="label">Điểm trừ khi không phục hồi được dữ liệu:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtDecrease_Percent_NoRecover" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
