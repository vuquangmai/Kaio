Public Class KpiInfrasDictIndexIntegrityDataEdit
    Inherits GlobalPage
#Region "Page Load"
        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "KPI HẠ TẦNG - CẬP NHẬT CHẤT LƯỢNG TOÀN VẸN DỮ LIỆU"
                    bindData(ViewState(ViewStateInfo.Object_Id))
                    ViewState(ViewStateInfo.Status) = Constants.Action.Update
                Else
                    Me.lbltitle.Text = "KPI HẠ TẦNG - THÊM CHẤT LƯỢNG TOÀN VẸN DỮ LIỆU"
...
#Region "Bind Data"
    Private Sub bindData(ByVal intId As Integer)
        Dim sql As String = "SELECT * FROM Kpi_Infras_DictIndex_Integrity_Data Where Id=" & intId
        ...
        If dt.Rows.Count > 0 Then
            ...
            Me.txtDecrease_Percent_NoRecover.Text = IIf(IsDBNull(dt.Rows(0).Item("Decrease_Percent_Max_Time")) = True, "", dt.Rows(0).Item("Decrease_Percent_NoRecover"))
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        If Me.txtDecrease_Percent_NoRecover.Text = "" Then
            Me.lblerror.Text = "Điểm trừ khi không khôi phục được dữ liệu không hợp lệ !"
            Exit Sub
        ElseIf Not IsNumeric(Me.txtDecrease_Percent_NoRecover.Text.Trim) Then
            Me.lblerror.Text = "Điểm trừ khi không khôi phục được dữ liệu phải là kiểu số !"
            Exit Sub
        End If
        ...
        Dim Decrease_Percent_NoRecover As Integer = Me.txtDecrease_Percent_NoRecover.Text.Trim
        ...
        Dim sql As String = ""
        sql = "SELECT * From  Kpi_Infras_DictIndex_Integrity_Data Where   Id <>" & ViewState(ViewStateInfo.Object_Id) & " And Criteria_Text=N'" & Criteria_Text & "'"
        If Me.IsCheckData(sql) = False Then
            ...
            ElseIf ViewState(ViewStateInfo.Status) = Constants.Action.Update Then
                sql = "UPDATE Kpi_Infras_DictIndex_Integrity_Data SET " & _
                           ...
                           "Decrease_Percent_NoRecover=N'" & Decrease_Percent_NoRecover & "'," & _
            ...
            Try
                ...
                RedirectUrl(Constants.Url._KPI.Infras.KpiInfrasDictIndexIntegrityDataList)
