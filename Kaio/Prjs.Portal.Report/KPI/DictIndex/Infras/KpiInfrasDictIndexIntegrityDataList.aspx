<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexIntegrityDataList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexIntegrityDataList" %>
            ...
            <div class="datagrid">
              <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="NGƯỠNG CHUẨN T/G">
                            <ItemStyle HorizontalAlign="Center" Width="8%" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="BƯỚC NHẢY T/G">
                        ...
                        <asp:TemplateColumn HeaderText="ĐIỂM TRỪ KHÔI PHỤC DỮ LIỆU">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="Decrease_Percent_NoRecover" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Decrease_Percent_NoRecover")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexIntegrityDataEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
