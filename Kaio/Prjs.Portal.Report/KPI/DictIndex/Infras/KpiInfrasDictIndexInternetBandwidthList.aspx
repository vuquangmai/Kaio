<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexInternetBandwidthList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexInternetBandwidthList" %>
                 ...
                 <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexInternetBandwidthEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
