<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexLeaseLineBandwidthEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexLeaseLineBandwidthEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblerror1" runat="server" CssClass="lblerror" Font-Italic="True" Font-Underline="True">Tốc độ băng thông kênh riêng:</asp:Label>
                        </td>
                        <td align="left">&nbsp;</td>
                    </tr>
                    <tr>
