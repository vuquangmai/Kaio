Public Class KpiInfrasDictIndexLeaseLineBandwidthEdit
    Inherits GlobalPage
#Region "Page Load"
        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "KPI HẠ TẦNG - CẬP NHẬT BĂNG THÔNG KÊNH RIÊNG"
                    bindData(ViewState(ViewStateInfo.Object_Id))
                    ViewState(ViewStateInfo.Status) = Constants.Action.Update
                Else
                    Me.lbltitle.Text = "KPI HẠ TẦNG - THÊM BĂNG THÔNG KÊNH RIÊNG"
...
#Region "Bind Data"
    Private Sub bindData(ByVal intId As Integer)
        Dim sql As String = "SELECT * FROM Kpi_Infras_DictIndex_LeaseLine_Bandwidth Where Id=" & intId
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        If Me.IsCheckData(sql) = False Then
            ...
            ElseIf ViewState(ViewStateInfo.Status) = Constants.Action.Update Then
                sql = "UPDATE Kpi_Infras_DictIndex_LeaseLine_Bandwidth SET " & _
    ...
    Protected Sub btnReturn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReturn.Click
        RedirectUrl(Constants.Url._KPI.Infras.KpiInfrasDictIndexLeaseLineBandwidthList)
    End Sub
