<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexSecurityList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexSecurityList" %>
               ...
               <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexSecurityEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
