<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexServiceMobileOperatorList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexServiceMobileOperatorList" %>
                    ...
                    <Columns>
                       ...
                       <asp:TemplateColumn HeaderText="GHI CHÚ">
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexServiceMobileOperatorEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
