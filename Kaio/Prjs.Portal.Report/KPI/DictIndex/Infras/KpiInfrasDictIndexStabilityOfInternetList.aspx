<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexStabilityOfInternetList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexStabilityOfInternetList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexStabilityOfInternetEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
