<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexStabilityOfLeaseLineList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexStabilityOfLeaseLineList" %>
                    ...
                    <Columns>
                       ...
                       <asp:TemplateColumn HeaderText="GHI CHÚ">
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexStabilityOfLeaseLineEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
