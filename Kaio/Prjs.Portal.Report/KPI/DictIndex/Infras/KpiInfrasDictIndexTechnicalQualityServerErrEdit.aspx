<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexTechnicalQualityServerErrEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexTechnicalQualityServerErrEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label37" runat="server" CssClass="label">Ngưỡng xử lý tối đa:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtStandar_Threshold_Handle_Max" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                            <asp:Label ID="lblTypeOf_Unit3" runat="server" CssClass="label"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label38" runat="server" CssClass="label">Điểm trừ  quá ngưỡng tối đa:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtDecrease_Percent_Max" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                            <asp:Label ID="Label39" runat="server" CssClass="label">%</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
