<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexTechnicalQualityServerErrList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexTechnicalQualityServerErrList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="ĐIỂM TRỪ QUÁ NGƯỠNG CHUẨN">
                            ...
                            <asp:TemplateColumn HeaderText="NGƯỠNG XL TỐI ĐA">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="Standar_Threshold_Handle_Max" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Standar_Threshold_Handle_Max")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="ĐIỂM TRỪ QUÁ NGƯỠNG TỐI ĐA">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="Decrease_Percent_Max" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Decrease_Percent_Max")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="GHI CHÚ">
                            <ItemStyle HorizontalAlign="Left" Width="15%" />
                            <ItemTemplate>
                                <asp:Label ID="Description" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Description")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexTechnicalQualityServerErrEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
