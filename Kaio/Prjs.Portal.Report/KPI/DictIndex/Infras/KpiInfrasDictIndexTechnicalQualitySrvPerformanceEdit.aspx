<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexTechnicalQualitySrvPerformanceEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexTechnicalQualitySrvPerformanceEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="Label36" runat="server" CssClass="label">Thang điểm đánh giá:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtPoint_Level" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                            <asp:Label ID="lblTypeOf_Unit2" runat="server" CssClass="label">%</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
