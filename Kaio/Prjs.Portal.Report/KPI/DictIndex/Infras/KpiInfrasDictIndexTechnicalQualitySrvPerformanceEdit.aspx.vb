Public Class KpiInfrasDictIndexTechnicalQualitySrvPerformanceEdit
    Inherits GlobalPage
#Region "Page Load"
        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "KPI HẠ TẦNG - CẬP NHẬT HIỆU NĂNG MÁY CHỦ"
                    bindData(ViewState(ViewStateInfo.Object_Id))
                    ViewState(ViewStateInfo.Status) = Constants.Action.Update
                Else
                    Me.lbltitle.Text = "KPI HẠ TẦNG - THÊM HIỆU NĂNG MÁY CHỦ"
...
#Region "Bind Data"
    Private Sub bindData(ByVal intId As Integer)
        Dim sql As String = "SELECT * FROM Kpi_Infras_DictIndex_Technical_Quality_Server_Performance Where Id=" & intId
        ...
        If dt.Rows.Count > 0 Then
            ...
            Me.txtPoint_Level.Text = IIf(IsDBNull(dt.Rows(0).Item("Point_Level")) = True, "", dt.Rows(0).Item("Point_Level"))
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        ElseIf Not IsNumeric(Me.txtStandar_Threshold_Handle.Text.Trim) Then
            ...
            Exit Sub
        End If
        If Me.txtPoint_Level.Text = "" Then
            Me.lblerror.Text = "Thang điểm đánh giá không hợp lệ !"
            Exit Sub
        ElseIf Not IsNumeric(Me.txtPoint_Level.Text.Trim) Then
            Me.lblerror.Text = "Thang điểm đánh giá phải là kiểu số !"
            Exit Sub
        End If
        ...
        Dim Point_Level As Integer = Me.txtPoint_Level.Text.Trim
        ...
        Dim sql As String = ""
        sql = "SELECT * From  Kpi_Infras_DictIndex_Technical_Quality_Server_Performance  Where   Id <>" & ViewState(ViewStateInfo.Object_Id) & " And Criteria_Text=N'" & Criteria_Text & "'"
        If Me.IsCheckData(sql) = False Then
            ...
            ElseIf ViewState(ViewStateInfo.Status) = Constants.Action.Update Then
                sql = "Update Kpi_Infras_DictIndex_Technical_Quality_Server_Performance Set Standar_Threshold_Handle=N'" & Standar_Threshold_Handle & "'," & _
                         "Point_Level=N'" & Point_Level & "'," & _
            ...
            Try
                ...
                RedirectUrl(Constants.Url._KPI.Infras.KpiInfrasDictIndexTechnicalQualitySrvPerformanceList)
