<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexTechnicalQualitySrvPerformanceList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexTechnicalQualitySrvPerformanceList" %>
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="THANG ĐIỂM ĐÁNH GIÁ">
                            <ItemStyle HorizontalAlign="Center" Width="15%" />
                            <ItemTemplate>
                                <asp:Label ID="Point_Level" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Point_Level")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexTechnicalQualitySrvPerformanceEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
