<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDictIndexTechnicalQualitySysDownTimeList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDictIndexTechnicalQualitySysDownTimeList" %>
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="NGƯỠNG MAX T/G">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="ĐIỂM TRỪ MAX T/G">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiInfrasDictIndexTechnicalQualitySysDownTimeEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
