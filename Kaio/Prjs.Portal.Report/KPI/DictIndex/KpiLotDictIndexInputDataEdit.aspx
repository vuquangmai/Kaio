<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexInputDataEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexInputDataEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:Label ID="Label26" runat="server" CssClass="label">Phút</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtStandar_Threshold_Handle_Over" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                            <asp:Label ID="Label27" runat="server" CssClass="label">Phút</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
