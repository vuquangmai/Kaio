<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexInputDataErrorList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexInputDataErrorList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiLotDictIndexInputDataErrorEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
