<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexInputDataList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexInputDataList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiLotDictIndexInputDataEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
