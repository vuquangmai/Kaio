<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexPercentageList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexPercentageList" %>
                            ...
                            <telerik:GridTableView DataKeyNames="ID" Name="Orders" Width="100%">
                                <DetailTables>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="SỬA">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <a class="datagridLinks" href='KpiLotDictIndexPercentageEdit.aspx?objid=<%# Utils.EncryptText(Eval("ID"))%>'
