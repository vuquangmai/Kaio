<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexTechnicalQualityMTEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexTechnicalQualityMTEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label31" runat="server" CssClass="label">Tỷ trọng:</asp:Label>
                        </td>
                        <td align="left">
