<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexTechnicalQualityMTErrList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexTechnicalQualityMTErrList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='/KPI/DictIndex/KpiLotDictIndexTechnicalQualityMTErrEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
