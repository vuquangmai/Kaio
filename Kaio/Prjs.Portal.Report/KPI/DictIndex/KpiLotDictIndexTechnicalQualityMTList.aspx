<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexTechnicalQualityMTList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexTechnicalQualityMTList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='/KPI/DictIndex/KpiLotDictIndexTechnicalQualityMTEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
