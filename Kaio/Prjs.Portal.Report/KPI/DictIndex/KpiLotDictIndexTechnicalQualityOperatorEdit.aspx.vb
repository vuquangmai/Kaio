Public Class KpiLotDictIndexTechnicalQualityOperatorEdit
    Inherits GlobalPage
#Region "Page Load"
        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "KPI DỊCH VỤ XỔ SỐ - CẬP NHẬT TỪ ĐIỂN THỜI GIAN GỬI MT SANG TELCOS"
                    bindData(ViewState(ViewStateInfo.Object_Id))
                    ViewState(ViewStateInfo.Status) = Constants.Action.Update
                Else
                    Me.lbltitle.Text = "KPI DỊCH VỤ XỔ SỐ - THÊM TỪ ĐIỂN THỜI GIAN GỬI MT SANG TELCOS"
...
#Region "Bind Data"
    Private Sub bindData(ByVal intId As Integer)
        Dim sql As String = "SELECT * FROM Kpi_Lot_DictIndex_Technical_Quality_Mobile_Operator Where Id=" & intId
...
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        Dim sql As String = ""
        sql = "SELECT * From  Kpi_Lot_DictIndex_Technical_Quality_Mobile_Operator  Where   Id <>" & ViewState(ViewStateInfo.Object_Id) & " And Criteria_Text=N'" & Criteria_Text & "'"
        If Me.IsCheckData(sql) = False Then
            ...
            ElseIf ViewState(ViewStateInfo.Status) = Constants.Action.Update Then
                sql = "Update Kpi_Lot_DictIndex_Technical_Quality_Mobile_Operator Set Standar_Threshold_Handle=N'" & Standar_Threshold_Handle & "'," & _
     ...
     " Where Id=" & ViewState(ViewStateInfo.Object_Id)
            ...
            Try
                ...
                RedirectUrl(Constants.Url._KPI.KpiLotDictIndexTechnicalQualityOperatorList)
