<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexTechnicalQualityOperatorList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexTechnicalQualityOperatorList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='/KPI/DictIndex/KpiLotDictIndexTechnicalQualityHandleEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
