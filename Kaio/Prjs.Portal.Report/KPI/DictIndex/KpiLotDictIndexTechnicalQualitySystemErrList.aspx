<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDictIndexTechnicalQualitySystemErrList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDictIndexTechnicalQualitySystemErrList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='/KPI/DictIndex/KpiLotDictIndexTechnicalQualitySystemErrEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
