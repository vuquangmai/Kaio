<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexCcareList.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexCcareList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="ĐIỂM TRỪ">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Decrease_Percent_Time" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Decrease_Percent")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiScratchCardDictIndexCcareEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
