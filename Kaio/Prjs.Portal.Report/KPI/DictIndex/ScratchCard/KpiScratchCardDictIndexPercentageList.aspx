<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexPercentageList.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexPercentageList" %>
                            ...
                            <telerik:GridTableView DataKeyNames="ID" Name="Orders" Width="100%">
                                <DetailTables>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="SỬA">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <a class="datagridLinks" href='KpiBrDictIndexPercentageEdit.aspx?objid=<%# Utils.EncryptText(Eval("ID"))%>'
