<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexTechnicalQualitySystemErrEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexTechnicalQualitySystemErrEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label35" runat="server" CssClass="label">Bước nhảy ngưỡng xử lý tối đa:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtStandar_Threshold_Handle_Max" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                            <asp:Label ID="lblTypeOf_Unit1" runat="server" CssClass="label"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label14" runat="server" CssClass="label">Điểm trừ thời gian:</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label28" runat="server" CssClass="label">Điểm trừ tối đa thời gian xử lý:</asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label31" runat="server" CssClass="label">Điểm trừ lỗi:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtDecrease_Percent_Error" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                            <asp:Label ID="Label32" runat="server" CssClass="label">%</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label33" runat="server" CssClass="label">Điểm trừ tối đa lỗi:</asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtDecrease_Percent_Max_Error" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="10%" Font-Bold="True"></asp:TextBox>
                            <asp:Label ID="Label34" runat="server" CssClass="label">%</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
