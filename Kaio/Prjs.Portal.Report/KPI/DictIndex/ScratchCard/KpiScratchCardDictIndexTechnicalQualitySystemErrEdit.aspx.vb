Public Class KpiScratchCardDictIndexTechnicalQualitySystemErrEdit
    Inherits GlobalPage
#Region "Page Load"
        ...
        If Not Me.IsPostBack Then
            ...
            If IsNumeric(ViewState(ViewStateInfo.Object_Id)) Then
                If ViewState(ViewStateInfo.Object_Id) > 0 Then
                    Me.lbltitle.Text = "KPI DỊCH VỤ THẺ CÀO - CẬP NHẬT TỪ ĐIỂN LỖI HỆ THỐNG"
                    bindData(ViewState(ViewStateInfo.Object_Id))
                    ViewState(ViewStateInfo.Status) = Constants.Action.Update
                Else
                    Me.lbltitle.Text = "KPI DỊCH VỤ THẺ CÀO - THÊM TỪ ĐIỂN LỖI HỆ THỐNG"
...
#Region "Bind Data"
    Private Sub bindData(ByVal intId As Integer)
        Dim sql As String = "SELECT * FROM Kpi_ScratchCard_DictIndex_Technical_Quality_System_Error Where Id=" & intId
        ...
        If dt.Rows.Count > 0 Then
            ...
            Me.lblTypeOf_Unit1.Text = IIf(IsDBNull(dt.Rows(0).Item("TypeOf_Unit")) = True, "", dt.Rows(0).Item("TypeOf_Unit"))
        End If
    End Sub
#End Region
#Region "Submit Click"
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        ElseIf Not IsNumeric(Me.txtStandar_Threshold_Handle_Over.Text.Trim) Then
            ...
            Exit Sub
        End If
        If Me.txtStandar_Threshold_Handle_Max.Text = "" Then
            Me.lblerror.Text = "Bước nhảy ngưỡng xử lý tối đa không hợp lệ !"
            Exit Sub
        ElseIf Not IsNumeric(Me.txtStandar_Threshold_Handle_Max.Text.Trim) Then
            Me.lblerror.Text = "Bước nhảy ngưỡng xử lý tối đa phải là kiểu số !"
            Exit Sub
        End If
        ...
        Dim sql As String = ""
        sql = "SELECT * From  Kpi_ScratchCard_DictIndex_Technical_Quality_System_Error  Where   Id <>" & ViewState(ViewStateInfo.Object_Id) & " And Criteria_Text=N'" & Criteria_Text & "'"
        If Me.IsCheckData(sql) = False Then
            ...
            ElseIf ViewState(ViewStateInfo.Status) = Constants.Action.Update Then
                sql = "Update Kpi_ScratchCard_DictIndex_Technical_Quality_System_Error Set Standar_Threshold_Handle=N'" & Standar_Threshold_Handle & "'," & _
            ...
            Try
                ...
                RedirectUrl(Constants.Url._KPI.ScratchCard.KpiScratchCardDictIndexTechnicalQualitySystemErrList)
