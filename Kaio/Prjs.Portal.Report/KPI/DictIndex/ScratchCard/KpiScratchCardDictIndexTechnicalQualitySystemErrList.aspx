<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexTechnicalQualitySystemErrList.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexTechnicalQualitySystemErrList" %>
            ...
            <div class="datagrid">
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="ĐIỂM TRỪ THỜI GIAN">
                            ...
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <asp:Label ID="Decrease_Percent_Error" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Decrease_Percent_Error")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiScratchCardDictIndexTechnicalQualitySystemErrEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
