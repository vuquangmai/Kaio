<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexTransactionPendingEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexTransactionPendingEdit" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label28" runat="server" CssClass="label">Điểm trừ tối đa ngưỡng xử lý:</asp:Label>
                        </td>
                        <td align="left">
