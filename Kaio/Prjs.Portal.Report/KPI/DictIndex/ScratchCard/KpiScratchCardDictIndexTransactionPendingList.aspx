<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexTransactionPendingList.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexTransactionPendingList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="ĐIỂM TRỪ">
                           ...
                           <asp:TemplateColumn HeaderText="NGƯỠNG TỐI ĐA">
                            <ItemStyle HorizontalAlign="Center" Width="8%" />
                            <ItemTemplate>
                             ...
                             <asp:TemplateColumn HeaderText="ĐIỂM TRỪ TỐI ĐA">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiScratchCardDictIndexTransactionPendingEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
