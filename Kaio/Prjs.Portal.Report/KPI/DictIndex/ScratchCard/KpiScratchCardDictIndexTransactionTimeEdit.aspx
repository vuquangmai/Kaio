<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexTransactionTimeEdit.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexTransactionTimeEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td align="right" width="30%">
                            <asp:Label ID="Label33" runat="server" CssClass="label">Tiêu chí:</asp:Label>
                        </td>
                        <td align="left">
