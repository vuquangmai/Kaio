<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDictIndexTransactionTimeList.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDictIndexTransactionTimeList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="THỂ LOẠI">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="TypeOf_Text" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Criteria_Text")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='KpiScratchCardDictIndexTransactionTimeEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
