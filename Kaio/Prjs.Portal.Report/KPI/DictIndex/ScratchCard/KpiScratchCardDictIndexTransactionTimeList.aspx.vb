Public Class KpiScratchCardDictIndexTransactionTimeList
    Inherits GlobalPage
    Public Utils As New Util.Encrypt
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "KPI DỊCH VỤ THẺ CÀO - TỪ ĐIỂN THỜI GIAN XỬ LÝ GIAO DỊCH"
            IsPrivilegeOnMenu()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT *,Row_Number() Over ( Order by Id ) as RowNumber  FROM Kpi_ScratchCard_DictIndex_Transaction_Time "
...
#Region "Submit button"
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ' RedirectUrl(Constants.Url._KPI.Brand.KpiBrDictIndexRoutingEdit)
    End Sub
#End Region
End Class