<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiBrCheckingQuality.aspx.vb" Inherits="Prjs.Portal.Report.KpiBrCheckingQuality" %>
                                    ...
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            <tr>
                                                ...
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label1" runat="server" CssClass="label">Thời gian tổng hợp số liệu:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label4" runat="server" CssClass="label">Thời gian gửi đối tác:</asp:Label>
                                                </td>
                                                <td align="left">
                                    ...
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            <tr>
                                                ...
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label96" runat="server" CssClass="label">T/g nhận bản cứng từ đối tác:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label8" runat="server" CssClass="label">T/g ĐSTC gửi QCS:</asp:Label>
                                                </td>
                                                <td align="left">
