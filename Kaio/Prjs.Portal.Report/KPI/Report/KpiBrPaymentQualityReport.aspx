<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiBrPaymentQualityReport.aspx.vb" Inherits="Prjs.Portal.Report.KpiBrPaymentQualityReport" %>
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            ...
                                            <tr>
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label99" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left" width="35%">
