<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiBrReportQualityReport.aspx.vb" Inherits="Prjs.Portal.Report.KpiBrReportQualityReport" %>
                                    ...
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <telerik:RadNumericTextBox ID="txtTotal_Program_Error_Threshold_Q1" runat="server" CssClass="txtContent" Culture="vi-VN" DataType="System.Int16" Font-Bold="True" Font-Names="Arial" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" LabelWidth="" ShowSpinButtons="true" Skin="Forest" Width="100px">
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            <tr>
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label93" runat="server" CssClass="label">Từ ngày:</asp:Label>
                                                </td>
                                                <td align="left" width="35%">
