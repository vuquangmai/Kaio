<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfasCardDataFileList.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfasCardDataFileList" %>
                    ...
                    <tr>
                        ...
                        <td align="left">
                                        <asp:DropDownList ID="DropDownListService_Id" runat="server" CssClass="droplist">
                                            ...
                                            <asp:ListItem Value="4">Hạ tầng</asp:ListItem>
                                        </asp:DropDownList>
                        </td>
                    </tr>
                    </table>
