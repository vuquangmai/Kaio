...
Public Class KpiInfasCardDataFileList
    Inherits GlobalPage
...
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO KPI HẠ TẦNG"
            BindYear()
            BindMonth()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT Month,TypeOf_Text,File_Name,File_Path,File_Url,Create_Time,Row_Number() Over ( Order by Month desc ) as RowNumber  FROM Kpi_Data_File" & _
             " WHERE TypeOf_Id= 4 AND Month=" & Me.DropDownListYear.SelectedItem.Value & IIf(Me.DropDownListMonth.SelectedItem.Value < 10, "0" & Me.DropDownListMonth.SelectedItem.Value, Me.DropDownListMonth.SelectedItem.Value)
