<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasCapacitySystemReport.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasCapacitySystemReport" %>
        ...
        <div id="HQ">
            <div class="alert">
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" Skin="Forest" Font-Bold="False" Font-Names="Arial" SelectedIndex="0">
                    <Tabs>
                        <telerik:RadTab Text="Khả năng chịu tải của hệ thống dịch vụ ( Với hạ tầng đang chạy)" Font-Names="Arial" Selected="True">
                        </telerik:RadTab>
                                        ...
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            ...
                                            <tr>
                                                <td align="right" class="auto-style2">
                                                    <asp:Label ID="Label95" runat="server" CssClass="label">Hệ thống dịch vụ:</asp:Label>
                                                </td>
