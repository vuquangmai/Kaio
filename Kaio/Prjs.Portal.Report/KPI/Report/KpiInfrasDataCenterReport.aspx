<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasDataCenterReport.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasDataCenterReport" %>
                            ...
                            <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            <tr>
                                                <td align="right" width="35%" class="auto-style3">
                                                    <asp:Label ID="Label96" runat="server" CssClass="label">Từ ngày:</asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label3" runat="server" CssClass="label">Tiêu chí:</asp:Label>
                                                </td>
                                                <td align="left">
