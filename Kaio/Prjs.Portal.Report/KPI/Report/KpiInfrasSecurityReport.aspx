<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasSecurityReport.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasSecurityReport" %>
        ...
        <div id="HQ">
            <div class="alert">
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" Skin="Forest" Font-Bold="False" Font-Names="Arial" SelectedIndex="0">
                    <Tabs>
                        <telerik:RadTab Text="Chất lượng bảo mật" Font-Names="Arial" Selected="True">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label1" runat="server" CssClass="label">Dịch vụ:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label77" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left">
