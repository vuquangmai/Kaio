<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiInfrasTechnicalQualityReport.aspx.vb" Inherits="Prjs.Portal.Report.KpiInfrasTechnicalQualityReport" %>
            ...
            <div class="alert">
                ...
                <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" Width="99%"
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageViewQ1" CssClass="PageView">
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label96" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalQ1" runat="server" CssClass="lblerror" Font-Bold="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <div class="submmit">
                            <asp:Button ID="btSearchQ1" runat="server" CssClass="btnbackground" Text="Tìm kiếm" />
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label4" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalQ2" runat="server" CssClass="lblerror" Font-Bold="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                            <tr>
                                                <td align="right" width="35%">
                                                    <asp:Label ID="Label5" runat="server" CssClass="label">Từ ngày:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label8" runat="server" CssClass="label">Dịch vụ:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:Label ID="lblTotalQ3" runat="server" CssClass="lblerror" Font-Bold="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
