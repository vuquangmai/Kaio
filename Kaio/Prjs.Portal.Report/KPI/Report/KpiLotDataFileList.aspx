<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiLotDataFileList.aspx.vb" Inherits="Prjs.Portal.Report.KpiLotDataFileList" %>
                    ...
                    <tr>
                        ...
                        <td align="left">
                                        <asp:DropDownList ID="DropDownListService_Id" runat="server" CssClass="droplist">
                                            ...
                                            <asp:ListItem Value="1">Xổ số</asp:ListItem>
                                        </asp:DropDownList>
                        </td>
                    </tr>
                    </table>
