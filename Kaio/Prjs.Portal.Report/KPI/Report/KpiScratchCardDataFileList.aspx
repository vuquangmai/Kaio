<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KpiScratchCardDataFileList.aspx.vb" Inherits="Prjs.Portal.Report.KpiScratchCardDataFileList" %>
                    ...
                    <tr>
                        ...
                        <td align="left">
                                        <asp:DropDownList ID="DropDownListService_Id" runat="server" CssClass="droplist">
                                            ...
                                            <asp:ListItem Value="3">Thẻ cào</asp:ListItem>
                                        </asp:DropDownList>
                        </td>
                    </tr>
                    </table>
