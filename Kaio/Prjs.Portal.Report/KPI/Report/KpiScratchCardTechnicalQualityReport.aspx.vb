...
Public Class KpiScratchCardTechnicalQualityReport
    Inherits GlobalPage
...
#Region "DictIndex"
    ...
    Private Sub BindErrorCodeQ1()
        ...
        Me.DropDownListErrorCodeQ1.Items.Add(New ListItem("--all--", 0))
...
#Region "Bind Data"
    Private Sub BindDataQ1(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim sql As String = "SELECT *,Row_Number() Over ( Order by Date_Text ) as RowNumber  FROM Kpi_ScratchCard_Technical_Quality_System_Error WHERE Date_Text>='" & FromDate & "' AND Date_Text<='" & ToDate & "'"
