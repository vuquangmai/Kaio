<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MGameDictIndexUrlList.aspx.vb" Inherits="Prjs.Portal.Report.MGameDictIndexUrlList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='MGameDictIndexUrlEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
