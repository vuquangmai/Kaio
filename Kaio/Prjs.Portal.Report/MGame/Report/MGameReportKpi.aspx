<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MGameReportKpi.aspx.vb" Inherits="Prjs.Portal.Report.MGameReportKpi" %>
            ...
            <div class="input" style="width: 50%">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <telerik:RadComboBox ID="RadDropDownListPartner_Id" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="True" Skin="Hay" Width="100%">
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="NGÀY">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblNGAY" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Date")%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Partner_Text">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblPartner_Text" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Partner_Text")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="Package_Text">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblPackage_Text" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "Package_Text")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Active_Member">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblActive_Member" runat="server" CssClass="label" Font-Bold="true" ForeColor="Blue">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Active_Member"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                           <asp:TemplateColumn HeaderText="Cancel_Member">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblCancel_Member" runat="server" CssClass="label" Font-Bold="true"  >   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Cancel_Member"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                         <asp:TemplateColumn HeaderText="Total_Download_Game">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblTotal_Download_Game" runat="server" CssClass="label" Font-Bold="true"  >   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Total_Download_Game"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="SMS_Registration">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblSMS_Registration" runat="server" CssClass="label">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "SMS_Registration"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="WAP_Registration">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblWAP_Registration" runat="server" ><%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "WAP_Registration"), 0)%>  </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Total_Registration">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblTotal_Registration" runat="server" CssClass="label" Font-Bold="true" ForeColor="red"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Total_Registration"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                       <asp:TemplateColumn HeaderText="SMS_Cancel">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblSMS_Cancel" runat="server" CssClass="label"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "SMS_Cancel"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                           <asp:TemplateColumn HeaderText="WAP_Cancel">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblWAP_Cancel" runat="server" CssClass="label"> <%# DataBinder.Eval(Container.DataItem, "WAP_Cancel")%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                           <asp:TemplateColumn HeaderText="Total_Cancel">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblTotal_Cancel" runat="server" CssClass="label" Font-Bold="true" ForeColor="red"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Total_Cancel"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="Renewal_Success">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblRenewal_Success" runat="server" CssClass="label"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Renewal_Success"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                              <asp:TemplateColumn HeaderText="Renewal_Error">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblRenewal_Error" runat="server" CssClass="label"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Renewal_Error"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                       <asp:TemplateColumn HeaderText="Total_Renewal">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblTotal_Renewal" runat="server" CssClass="label" Font-Bold="true" ForeColor="red"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Total_Renewal"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="Money_Download_Game">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblMoney_Download_Game" runat="server" CssClass="label"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Money_Download_Game"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="Money_Renewal">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblMoney_Renewal" runat="server" CssClass="label"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Money_Renewal"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="Money_Ccare">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblMoney_Ccare" runat="server" CssClass="label" Font-Bold="true" ForeColor="Black"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Money_Ccare"), 0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
