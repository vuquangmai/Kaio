<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SMSDictIndexKeywordDeclareHandle.aspx.vb" Inherits="Prjs.Portal.Report.SMSDictIndexKeywordDeclareHandle" %>
            ...
            <div class="alert">
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
                    ...
                    <Tabs>
                        ...
                        <telerik:RadTab Text="Định tuyến mã" Font-Names="Arial">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Khai báo Telcos" Font-Names="Arial">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Khai báo Filter, Report" Font-Names="Arial">
                        </telerik:RadTab>
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageViewQ6" CssClass="PageView">
                                    ...
                                    <td align="center">
                                        <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                            ...
                                            <tr>
                                                <td align="right">&nbsp;</td>
                                                <td align="left">
                                                    <asp:CheckBox ID="CheckBoxAllDateQ6" runat="server" CssClass="checkbox" Text="Toàn thời gian" />
                                                </td>
                                                <td align="right">
                        ...
                        <div class="datagrid">
                            <telerik:RadGrid ID="RadGridQ6" runat="server" AllowMultiRowSelection="False" AllowPaging="True"
                                AllowSorting="True" AutoGenerateColumns="False" PageSize="300" ShowStatusBar="true"
                                Skin="Hay" SortingSettings-SortedBackColor="Azure" StatusBarSettings-ReadyText="Customer Care Portal - Kaio Corp"
                                Width="100%">
                                <HeaderStyle Font-Names="Arial" Font-Size="8pt" />
                                <ItemStyle Font-Names="Arial" Font-Size="8pt" ForeColor="Black" />
                       ...
                       <telerik:RadPageView runat="server" ID="RadPageViewQ7" CssClass="PageView">
                                    ...
                                    <td align="center">
                                        <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="Label10" runat="server" CssClass="label">Đầu số:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="Label11" runat="server" CssClass="label">Mã dịch vụ:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                        <tr>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label12" runat="server" CssClass="label">Trạng thái:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label14" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalQ7" runat="server" CssClass="lblerror"></asp:Label>
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label15" runat="server" CssClass="label">Đối tác:</asp:Label>
                                                </td>
                                                <td align="left">
                        ...
                        <div class="submmit">
                            ...
                            <asp:Button ID="btnExpQ7" runat="server" CssClass="btnbackground"
                             ...
                             <div class="pager">
                <cc1:PagerV2_8 ID="pagerQ7" runat="server" OnCommand="pager_Command" GenerateGoToSection="true"
                    Font-Size="10pt" PageSize="50" />

            </div>
                        <div class="datagrid">
                              <asp:DataGrid ID="DataGridQ7" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                              <asp:Label ID="lblRowNumberQ7" runat="server" Text='<%# Eval("RowNumber") %>'></asp:Label>
                            </ItemTemplate>
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageViewQ8" CssClass="PageView">
                        <div class="parametter" style="margin: 1px auto 1px auto; border-color: #B4B4B4; width: 98%; background-color: #E1EDD4;">
                            <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                ...
                                <tr>
                                    <td align="right" width="20%">
                                        <asp:Label ID="Label115" runat="server" CssClass="label">Tên dịch vụ:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtService_TextQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Font-Bold="False" ReadOnly="True" Width="90%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="20%">
                                        <asp:Label ID="Label116" runat="server" CssClass="label">Số lượng MT:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtTotal_MTQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Font-Bold="False" ReadOnly="True" Width="10%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="20%">
                                        <asp:Label ID="Label117" runat="server" CssClass="label">Mô tả dịch vụ:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtService_DescriptionQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Font-Bold="False" Height="53px" ReadOnly="True" TextMode="MultiLine" Width="90%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="20%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="DropDownListTypeOf_MT_IdQ8" runat="server" AutoPostBack="True" CssClass="droplist">
                                            <asp:ListItem Value="0">--Chọn--</asp:ListItem>
