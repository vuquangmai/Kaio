<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SMSDictIndexKeywordDeclareList.aspx.vb" Inherits="Prjs.Portal.Report.SMSDictIndexKeywordDeclareList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                 <asp:Label ID="lblEdit" runat="server" CssClass="label"   Visible=' <%#SetVisibleEdit(Eval("Status_Id"), Eval("Is_Handle"))%>'  >
                                      <a class="datagridLinks" title="Sửa đổi thông tin" href='SMSDictIndexKeywordDeclareEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="deleter" runat="server" title="Delete" BorderStyle="None"
                                    ...
                                    ImageAlign="absmiddle" ImageUrl="~/Images/del.gif" OnCommand="DelData"  Visible=' <%#SetVisibleDelete(Eval("Status_Id"), Eval("Is_Handle"))%>'  />
                            </ItemTemplate>
