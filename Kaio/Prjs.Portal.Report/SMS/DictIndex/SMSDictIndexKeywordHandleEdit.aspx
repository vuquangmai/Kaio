<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SMSDictIndexKeywordHandleEdit.aspx.vb" Inherits="Prjs.Portal.Report.SMSDictIndexKeywordHandleEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="AjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="DropDownListRangeShortCodeQ3">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="DropDownListShortCodeQ3" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="DropDownListDepartment_IdQ3">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="DropDownListPartner_IdQ3" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="DropDownListRangeShortCodeQ6">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="DropDownListShortCodeQ6" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="DropDownListDepartment_IdQ6">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="DropDownListPartner_IdQ6" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            ...
            <div class="alert">
                ...
                <telerik:RadTabStrip runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1"
                    ...
                    <Tabs>
                        ...
                        <telerik:RadTab Text="Sửa định tuyến mã" Font-Names="Arial">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Sửa khai báo Telcos" Font-Names="Arial">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Sửa khai báo Filter, Report" Font-Names="Arial">
                        </telerik:RadTab>
                        <telerik:RadTab Text="Gán doanh thu" Font-Names="Arial">
                        </telerik:RadTab>
                ...
                <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="4" Width="99%"
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageViewQ3" CssClass="PageView">
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                            <tr>
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label9" runat="server" CssClass="label">Từ ngày:</asp:Label>
                                                </td>
                                                <td align="left" width="35%">
                                                    <telerik:RadDatePicker ID="RadFromDateQ3" rMinDate="2006/01/01" runat="server"
                                                        ZIndex="30001" Culture="vi-VN" Skin="Forest">
                                                        <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"
                                                            Skin="Forest">
                                                        </Calendar>
                                                ...
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label17" runat="server" CssClass="label">Dải số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListRangeShortCodeQ3" runat="server" CssClass="droplist" Font-Bold="True" AutoPostBack="True">
                                                        <asp:ListItem>--all--</asp:ListItem>
                                                        <asp:ListItem>99x</asp:ListItem>
                                                        <asp:ListItem>8x79</asp:ListItem>
                                                        <asp:ListItem>8x99</asp:ListItem>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label18" runat="server" CssClass="label">Đến ngày:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <telerik:RadDatePicker ID="RadToDateQ3" rMinDate="2006/01/01" runat="server"
                                                        ZIndex="30001" Culture="vi-VN" Skin="Forest">
                                                        <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"
                                                            Skin="Forest">
                                                        </Calendar>
                                                ...
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListShortCodeQ3" runat="server" CssClass="droplist" Font-Bold="False">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">&nbsp;</td>
                                                <td align="left">
                                                    <asp:CheckBox ID="CheckBoxAllDateQ3" runat="server" Checked="True" CssClass="checkbox" Text="Toàn thời gian" />
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label28" runat="server" CssClass="label">Mã dịch vụ:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                        <tr>
                                                            <td width="50%">
                                                                <asp:TextBox ID="txtKeyWordQ3" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                                    Width="80%"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox ID="CheckBoxKeywordQ3" runat="server" CssClass="checkbox" Text="Tương đối" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label29" runat="server" CssClass="label">Trạng thái:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListStatus_IdQ3" runat="server" CssClass="droplist">
                                                    </asp:DropDownList>
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label68" runat="server" CssClass="label">Phòng ban:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListDepartment_IdQ3" runat="server" CssClass="droplist" AutoPostBack="True">
                                                        <asp:ListItem>--all--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label69" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalQ3" runat="server" CssClass="lblerror"></asp:Label>
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label70" runat="server" CssClass="label">Đối tác:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListPartner_IdQ3" runat="server" CssClass="droplist">
                                                        <asp:ListItem>--all--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                        ...
                        <div class="submmit">
                            <asp:Button ID="btnSearchingQ3" runat="server" CssClass="btnbackground"
                                Text="Tìm kiếm" />
                            <asp:Button ID="btnExpQ3" runat="server" CssClass="btnbackground"
                                Text="Báo cáo" />
                        </div>
                        <div class="datagrid">
                            <telerik:RadGrid ID="RadGridQ3" runat="server" AllowMultiRowSelection="False" AllowPaging="True"
                                AllowSorting="True" AutoGenerateColumns="False" PageSize="30" ShowStatusBar="true"
                                Skin="Hay" SortingSettings-SortedBackColor="Azure" StatusBarSettings-ReadyText="Customer Care Portal - Kaio Corp"
                                Width="100%">
                                <HeaderStyle Font-Names="Arial" Font-Size="8pt" />
                                ...
                                <MasterTableView AllowMultiColumnSorting="True" DataKeyNames="ID" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="STT" SortExpression="RowNumber">
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowNumberQ3" runat="server" Text='<%# Eval("RowNumber") %>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="ID">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="IdQ3" runat="server" CssClass="ItemsText" Font-Bold="true"> <a href="JavaScript:IsDetail('<%#Utils.EncryptText(Eval("Id") ) %>')"  title="Thông tin chi tiết" ><%# Eval("Id")%> </a>
                                                </asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="THỂ LOẠI">
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="TypeOf_Ticket_TextQ3" runat="server" Text='<%# Eval("TypeOf_Ticket_Text")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="MÃ">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Key_WordQ3" runat="server" Font-Bold="true" Text='<%# Eval("Key_Word")%>'></asp:Label>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="ĐẦU SỐ">
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" Font-Bold="true" />
                                            <ItemTemplate>
                                                <asp:Label ID="Short_CodeQ3" runat="server" Text='<%# Eval("Short_Code")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="DỊCH VỤ">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Cate1_TextQ3" runat="server" Text='<%# Eval("Cate1_Text")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="TRẠNG THÁI">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Status_TextQ3" runat="server" Text='<%# Eval("Status_Text")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="T/G TẠO">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Create_TimeQ3" runat="server" Text='<%# DateTime.Parse(Eval("Create_Time")).ToString("dd-MM-yyyy HH:mm:ss")%>'></asp:Label>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="XỬ LÝ">
                                            ...
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="lnkQ3" ToolTip="Xử lý" OnCommand="lnkQ3_Click"
                                                    CommandArgument='<%#Eval("ID")%>'><img border="0" src="/images/comment-edit-icon.png" /></asp:LinkButton>
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageViewQ6" CssClass="PageView">
                        <div class="parametter" style="margin: 1px auto 1px auto; border-color: #B4B4B4; width: 80%; background-color: #E1EDD4;">
                            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                            <tr>
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label42" runat="server" CssClass="label">Từ ngày:</asp:Label>
                                                </td>
                                                <td align="left" width="35%">
                                                    <telerik:RadDatePicker ID="RadFromDateQ6" rMinDate="2006/01/01" runat="server"
                                                        ZIndex="30001" Culture="vi-VN" Skin="Forest">
                                                        <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"
                                                            Skin="Forest">
                                                        </Calendar>
                                                ...
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label43" runat="server" CssClass="label">Dải số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListRangeShortCodeQ6" runat="server" CssClass="droplist" Font-Bold="True" AutoPostBack="True">
                                                        <asp:ListItem>--all--</asp:ListItem>
                                                        <asp:ListItem>99x</asp:ListItem>
                                                        <asp:ListItem>8x79</asp:ListItem>
                                                        <asp:ListItem>8x99</asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <telerik:RadDatePicker ID="RadToDateQ6" rMinDate="2006/01/01" runat="server"
                                                        ZIndex="30001" Culture="vi-VN" Skin="Forest">
                                                        <Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"
                                                            Skin="Forest">
                                                        </Calendar>
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="Label45" runat="server" CssClass="label">Đầu số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListShortCodeQ6" runat="server" CssClass="droplist" Font-Bold="False">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">&nbsp;</td>
                                                <td align="left">
                                                    <asp:CheckBox ID="CheckBoxAllDateQ6" runat="server" Checked="True" CssClass="checkbox" Text="Toàn thời gian" />
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label46" runat="server" CssClass="label">Mã dịch vụ:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                        <tr>
                                                            <td width="50%">
                                                                <asp:TextBox ID="txtKeyWordQ6" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                                    Width="80%"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox ID="CheckBoxKeywordQ6" runat="server" CssClass="checkbox" Text="Tương đối" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListStatus_IdQ6" runat="server" CssClass="droplist">
                                                    </asp:DropDownList>
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label77" runat="server" CssClass="label">Phòng ban:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListDepartment_IdQ6" runat="server" CssClass="droplist" AutoPostBack="True">
                                                        <asp:ListItem>--all--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label78" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalQ6" runat="server" CssClass="lblerror"></asp:Label>
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label79" runat="server" CssClass="label">Đối tác:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="DropDownListPartner_IdQ6" runat="server" CssClass="droplist">
                                                        <asp:ListItem>--all--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                        ...
                        <div class="submmit">
                            <asp:Button ID="btnSearchingQ6" runat="server" CssClass="btnbackground"
                                Text="Tìm kiếm" />
                            <asp:Button ID="btnExpQ6" runat="server" CssClass="btnbackground"
                                Text="Báo cáo" />
                        </div>
                        <div class="datagrid">
                            <telerik:RadGrid ID="RadGridQ6" runat="server" AllowMultiRowSelection="False" AllowPaging="True"
                                AllowSorting="True" AutoGenerateColumns="False" PageSize="30" ShowStatusBar="true"
                                Skin="Hay" SortingSettings-SortedBackColor="Azure" StatusBarSettings-ReadyText="Customer Care Portal - Kaio Corp"
                                Width="100%">
                                <HeaderStyle Font-Names="Arial" Font-Size="8pt" />
                                ...
                                <MasterTableView AllowMultiColumnSorting="True" DataKeyNames="ID" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="STT" SortExpression="RowNumber">
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowNumberQ6" runat="server" Text='<%# Eval("RowNumber") %>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="ID">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="IdQ6" runat="server" CssClass="ItemsText" Font-Bold="true"> <a href="JavaScript:IsDetail('<%#Utils.EncryptText(Eval("Id") ) %>')"  title="Thông tin chi tiết" ><%# Eval("Id")%> </a>
                                                </asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="THỂ LOẠI">
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="TypeOf_Ticket_TextQ6" runat="server" Text='<%# Eval("TypeOf_Ticket_Text")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="MÃ">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Key_WordQ6" runat="server" Font-Bold="true" Text='<%# Eval("Key_Word")%>'></asp:Label>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="ĐẦU SỐ">
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" Font-Bold="true" />
                                            <ItemTemplate>
                                                <asp:Label ID="Short_CodeQ6" runat="server" Text='<%# Eval("Short_Code")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="DỊCH VỤ">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Cate1_TextQ6" runat="server" Text='<%# Eval("Cate1_Text")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="TRẠNG THÁI">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Status_TextQ6" runat="server" Text='<%# Eval("Status_Text")%>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="T/G TẠO">
                                            <HeaderStyle Font-Bold="true" Font-Names="Arial" Font-Size="10px" HorizontalAlign="Center"
                                            ...
                                            <ItemStyle Font-Names="Arial" Font-Size="11px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="Create_TimeQ6" runat="server" Text='<%# DateTime.Parse(Eval("Create_Time")).ToString("dd-MM-yyyy HH:mm:ss")%>'></asp:Label>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="XỬ LÝ">
                                            ...
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="lnkQ6" ToolTip="Xử lý" OnCommand="lnkQ6_Click"
                                                    CommandArgument='<%#Eval("ID")%>'><img border="0" src="/images/comment-edit-icon.png" /></asp:LinkButton>
                  ...
                  <telerik:RadPageView runat="server" ID="RadPageViewQ7" CssClass="PageView">
                                ...
                                <tr>
                                    <td align="center">
                                        <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                                            <tr>
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label11" runat="server" CssClass="label">Từ ngày:</asp:Label>
                                                </td>
                                                <td align="left" width="35%">
                                                ...
                                                <td align="right" width="15%">
                                                    <asp:Label ID="Label12" runat="server" CssClass="label">Dải số:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="Label19" runat="server" CssClass="label">Mã dịch vụ:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                        <tr>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label20" runat="server" CssClass="label">Trạng thái:</asp:Label>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="right">
                                                    <asp:Label ID="Label21" runat="server" CssClass="label">Phòng ban:</asp:Label>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <asp:Label ID="Label22" runat="server" CssClass="label">Tổng số:</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="lblTotalQ7" runat="server" CssClass="lblerror"></asp:Label>
                                                </td>
                                                <td align="right">
                                                    <asp:Label ID="Label23" runat="server" CssClass="label">Đối tác:</asp:Label>
                                                </td>
                                                <td align="left">
                    ...
                    <telerik:RadPageView runat="server" ID="RadPageViewQ8" CssClass="PageView">
                        <div class="parametter" style="margin: 1px auto 1px auto; border-color: #B4B4B4; width: 100%; background-color: #E1EDD4;">
                            ...
                            <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="DropDownListTypeOf_Ticket_IdQ8" runat="server" AutoPostBack="True" CssClass="droplist">
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label3" runat="server" CssClass="label">Phòng ban:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:DropDownList ID="DropDownListDepartment_IdQ8" runat="server" CssClass="droplist" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label5" runat="server" CssClass="label">Đối tác sở hữu:</asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:DropDownList ID="DropDownListPartner_IdQ8" runat="server" CssClass="droplist">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <table cellpadding="0" class="auto-style2">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtRouting_Url_EditQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                        Width="90%" Font-Bold="False"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td align="left">
                                        <table cellpadding="0" class="auto-style2">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtMT_EditQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                        Width="100%" Font-Bold="False" Height="38px" TextMode="MultiLine"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="auto-style3">
                                        <table cellpadding="0" class="auto-style2">
                                            <tr>
                                                <td width="40%">
                                                    <asp:TextBox ID="txtTotal_MTQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotal_MT_EditQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                        Width="50px" Font-Bold="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table cellpadding="0" class="auto-style2">
                                            <tr>
                                                <td width="40%">
                                                    ...
                                                    <asp:TextBox ID="txtService_TextQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                        Width="90%" Font-Bold="False"></asp:TextBox>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtService_Text_EditQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                        Width="90%" Font-Bold="False"></asp:TextBox>
                                        ...
                                        <table cellpadding="0" class="auto-style2">
                                            <tr>
                                                <td width="40%">
                                                    ...
                                                    <asp:TextBox ID="txtService_DescriptionQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtService_Description_EditQ8" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                                        Width="90%" Font-Bold="False" Height="39px" TextMode="MultiLine"></asp:TextBox>
                                        ...
                                        <table cellpadding="0" class="auto-style2">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Label ID="lblUserFile_EditQ8" runat="server" CssClass="label" ForeColor="#0033CC"></asp:Label>
                                        ...
                                        <table cellpadding="0" class="auto-style2">
                                            <tr>
                                                <td width="40%">
                                                    ...
                                                    <asp:DropDownList ID="DropDownListCate_1Q8" runat="server" CssClass="droplist">
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:DropDownList ID="DropDownListCate1_EditQ8" runat="server" CssClass="droplist">
                                                    </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="DropDownListStatus_IdQ8" runat="server" CssClass="droplist">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="DropDownListStatus_IdQ8Proc" runat="server" AutoPostBack="True" CssClass="droplist">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
