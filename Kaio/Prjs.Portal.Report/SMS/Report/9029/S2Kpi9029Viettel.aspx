<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2Kpi9029Viettel.aspx.vb" Inherits="Prjs.Portal.Report.S2Kpi9029Viettel" %>
        ...
        <div id="HQ">
            ...
            <div class="input" style="width: 50%">
                <table width="100%">
                    ...
                    <tr>
                        <td align="right">
                                <asp:CheckBox ID="CheckBoxKeyword" runat="server" CssClass="checkbox" Text="Mã:" TextAlign="Left" />
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtKeyword" runat="server" CssClass="txtContent" Width="30%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
          ...
          <table cellpadding="0" class="auto-style1">
                           <tr>
                               ...
                               <td rowspan="2" width="6%">NGÀY</td>
                               <td rowspan="2" width="6%">ĐỐI TÁC</td>
                               <td rowspan="2" width="6%">MÃ</td>
                               <td rowspan="2" width="6%">THUÊ BAO LŨY KẾ</td>
                               <td colspan="3" width="18%">ĐĂNG KÝ MỚI</td>
                               <td colspan="3" width="18%">THUÊ BAO HỦY</td>
                               <td rowspan="2" width="6%">TỔNG GIA HẠN THÀNH CÔNG</td>
                               <td rowspan="2"  width="6%">TỔNG GIA HẠN</td>
                                <td rowspan="2"  width="6%">TỔNG TIỀN ĐK</td>
                                <td rowspan="2"  width="6%">TỔNG TIỀN GIA HẠN</td>
                                <td rowspan="2"  width="6%">TỔNG DOANH THU</td>
                           </tr>
                           <tr>
                               <td width="6%"> <asp:Label ID="Label0" runat="server" CssClass="label"  Font-Bold="false">SMS</asp:Label></td>
                               <td width="6%"><asp:Label ID="Label1" runat="server" CssClass="label"  Font-Bold="false"> WAP</asp:Label></td>
                               <td width="6%"><asp:Label ID="Label2" runat="server" CssClass="label"  Font-Bold="false">TỔNG ĐK MỚI</asp:Label></td>
                               <td width="6%"><asp:Label ID="Label3" runat="server" CssClass="label"  Font-Bold="false">SMS</asp:Label></td>
                               <td width="6%"><asp:Label ID="Label4" runat="server" CssClass="label"  Font-Bold="false">WAP</asp:Label></td>
                                <td width="6%"><asp:Label ID="Label6" runat="server" CssClass="label"  Font-Bold="false">TỔNG HỦY</asp:Label></td>
                           </tr>
                       </table>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="TEN_DOI_TAC">
                          ...
                          <asp:TemplateColumn HeaderText="MA">
                            <ItemStyle Width="6%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblMA" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "MA")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                       ...
                       <asp:TemplateColumn HeaderText="TONG_GIA_HAN">
                          ...
                          <asp:TemplateColumn HeaderText="TONG_TIEN_TU_DANG_KY">
                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                   <asp:Label ID="lblTONG_TIEN_TU_DANG_KY" runat="server" CssClass="label"> <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "TONG_TIEN_TU_DANG_KY"),0)%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
