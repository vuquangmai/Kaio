...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        sql = "SELECT Year(NGAY) Year," & _
                ...
                " SUM( CAST( THUE_BAO_LUY_KE AS decimal(18,0) ))  THUE_BAO_LUY_KE, " & _
                " SUM( CAST( DANG_KY_MOI_SMS AS decimal(18,0) )) DANG_KY_MOI_SMS, " & _
                " SUM( CAST( DANG_KY_MOI_WAP AS decimal(18,0) )) DANG_KY_MOI_WAP, " & _
                " SUM( CAST( TONG_DANG_KY_MOI AS decimal(18,0) )) TONG_DANG_KY_MOI, " & _
                " SUM( CAST( HUY_SMS AS decimal(18,0) )) HUY_SMS, " & _
                " SUM( CAST( HUY_WAP AS decimal(18,0) )) HUY_WAP, " & _
                " SUM( CAST( TONG_HUY AS decimal(18,0) )) TONG_HUY, " & _
                " SUM( CAST( GIA_HAN_THANH_CONG AS decimal(18,0) )) GIA_HAN_THANH_CONG, " & _
                " SUM( CAST( TONG_GIA_HAN AS decimal(18,0) )) TONG_GIA_HAN, " & _
                " SUM( CAST( TONG_TIEN_TU_DANG_KY AS decimal(18,0) )) TONG_TIEN_TU_DANG_KY, " & _
                " SUM( CAST( TONG_TIEN_TU_GIA_HAN AS decimal(18,0) ))TONG_TIEN_TU_GIA_HAN, " & _
                " SUM( CAST( TONG_DOANH_THU AS decimal(18,0) )) TONG_DOANH_THU, " & _
