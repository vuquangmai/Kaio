<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SMS9977Viettelsubscribe.aspx.vb" Inherits="Prjs.Portal.Report.SMS9977Viettelsubscribe" %>
        ...
        <div id="HQ">
            ...
            <div class="parametter">
                <table width="100%">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblTrang10" runat="server" CssClass="label">Dịch vụ:</asp:Label>
                        </td>
                        <td align="left">

                            <asp:TextBox ID="txtServicId" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AutoGenerateColumns="false" CellPadding="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="MÃ">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "command")%>
                            </ItemTemplate>
