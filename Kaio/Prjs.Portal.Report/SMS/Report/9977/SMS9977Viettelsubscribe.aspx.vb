...
Public Class SMS9977Viettelsubscribe
    Inherits GlobalPage
...
#Region "Page Load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lblTitle.Text = "LOG GIAO DỊCH SUBS"
            BindDate()
...
#Region "Bind Data"
    Private Sub bindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        Dim vTable As String = "subscribe"
        ...
        Dim sql As String = "SELECT * FROM subscribe  WHERE date_format(Created_at,'%Y%m%d')>='" & FromDate & "'"
