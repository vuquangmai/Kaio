<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MobileTrafficOnlineCDR.aspx.vb" Inherits="Prjs.Portal.Report.MobileTrafficOnlineCDR" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AutoGenerateColumns="false" CellPadding="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="TRẠNG THÁI">
                          ...
                          <asp:TemplateColumn HeaderText="SỐ MT">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "number_message")%>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                        </asp:TemplateColumn>
                          <asp:TemplateColumn HeaderText="TÍNH CƯỚC">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem, "message_type")%>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                        </asp:TemplateColumn>
