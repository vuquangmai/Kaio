<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Banner.aspx.vb" Inherits="Prjs.Portal.Report.SimToolKit_Banner" %>
            ...
            <div class="menucontent">
                <div class="top">
                    <ul>
                        ...
                        <li class="liselected">
                            <asp:Label ID="lblSimToolKitChannel" runat="server"><a href="../SimToolKit/Index.aspx?channel=53043b94b309e8e9c246d8b93da449a4" target="_parent" style="color: #377F44">
