<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2DictIndexVMSServiceList.aspx.vb" Inherits="Prjs.Portal.Report.S2DictIndexVMSServiceList" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a class="datagridLinks" title="Sửa đổi thông tin" href='S2DictIndexVMSServiceEdit.aspx?objid=<%# Utils.EncryptText(DataBinder.Eval(Container.DataItem, "ID")) %>'>
