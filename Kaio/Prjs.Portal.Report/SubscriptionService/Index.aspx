<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Index.aspx.vb" Inherits="Prjs.Portal.Report.SubscriptionService_Index" %>
...
<frameset framespacing="0" border="0" frameborder="no" rows="55,*,20" name="MainFrame">
		...
		<frameset id="frameset1"  framespacing="0" border="1" frameborder="no" cols="180,*"  bordercolor =blue  >
