...
#Region "Page load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO KPI DỊCH VỤ 94x V//"
            BindDictIndex()
...
#Region "DictIndex"
    ...
    Private Sub BindPartnerd()
        Dim sql As String = "SELECT * FROM S2_TTND_Partners WHERE PartnerId>0"
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim vTable As String = "Report_VNM_94x"
        ...
        Dim dtUserData As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString("SqlConnectionString_168_2"), sql_1)
        Dim ThueBaoLuyKe As Integer = dtUserData.Rows(0).Item("THUE_BAO_LUY_KE")
        If strAction = Constants.Action.Search Then
            Dim dtPageCount As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString("SqlConnectionString_168_2"), "SELECT count(*) Total,  cast(SUM(TONG_DOANH_THU) as decimal(18,0)) TONG_DOANH_THU,  cast(SUM(TONG_DOANH_THU_VMG)  as decimal(18,0))TONG_DOANH_THU_VMG  FROM (" & sql & ") T")
