...
#Region "Page load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO KPI DỊCH VỤ VISPORT V//"
            BindDictIndex()
...
#Region "DictIndex"
    ...
    Private Sub BindPartnerd()
        ...
        'Dim dt As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString("SqlConnectionString_168_3"), sql)
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim vTable As String = "Report_VNM_Visport"
        ...
        sql = "SELECT Year(NGAY) Year," & _
                ...
                " round(SUM(cast(TONG_DOANH_THU as decimal(18,0)))*40/100,0)  TONG_DOANH_THU_VMG, " & _
        ...
        Dim dtUserData As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString("SqlConnectionString_168_3"), sql_1)
        Dim ThueBaoLuyKe As Integer = dtUserData.Rows(0).Item("THUE_BAO_LUY_KE")
        If strAction = Constants.Action.Search Then
            Dim dtPageCount As DataTable = MSSQLEnv.BuildDataTable.sqlText(IsSqlConnection.BuildSqlConnectionString("SqlConnectionString_168_3"), "SELECT count(*) Total,  cast(SUM(TONG_DOANH_THU) as decimal(18,0)) TONG_DOANH_THU,  cast(SUM(TONG_DOANH_THU_VMG)  as decimal(18,0))TONG_DOANH_THU_VMG  FROM (" & sql & ") T")
