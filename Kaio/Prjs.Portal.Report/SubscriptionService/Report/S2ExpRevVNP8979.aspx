<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2ExpRevVNP8979.aspx.vb" Inherits="Prjs.Portal.Report.S2ExpRevVNP8979" %>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <telerik:RadComboBox ID="RadDropListMobile_Operator" runat="server"   EnableCheckAllItemsCheckBox="True" Skin="Hay" Width="100px" AutoPostBack="True">
                                    <Items>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <telerik:RadComboBox ID="RadDropDownListAccess_Number" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="True" Skin="Hay" Width="100px">
                                    <Items>
                                        <telerik:RadComboBoxItem Text="8979" Value="8979" />
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="DỊCH VỤ">
                          ...
                          <asp:TemplateColumn HeaderText="MÃ ĐK">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblCDR" runat="server" CssClass="label" Font-Bold="true">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "CDR"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="TELCO HƯỞNG">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText=" ĐỐI TÁC HƯỞNG">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="VMG HƯỞNG">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
