<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2OnlineUserVNM94x.aspx.vb" Inherits="Prjs.Portal.Report.S2OnlineUserVNM94x" %>
                ...
                <div class="input">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:CheckBox ID="CheckBoxChannel" runat="server" CssClass="checkbox" Text="Kênh:" TextAlign="Left" />
                            </td>
                            <td align="left">
                                <telerik:RadComboBox ID="RadDropDownListChannel" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="True" Skin="Hay" Width="100px">
                                    <Items>
                                        <telerik:RadComboBoxItem Text="SMS" />
                                        <telerik:RadComboBoxItem Text="WAP" />
                                        <telerik:RadComboBoxItem Text="STK" />
                                        <telerik:RadComboBoxItem Text="LiveNews" />
                                    </Items>
                        ...
                        <tr>
                            <td align="right">
                                <asp:Label ID="lblTrang13" runat="server" CssClass="label">Hình thức hủy:</asp:Label>
                            </td>
                            <td align="left">
                                <asp:DropDownList ID="DropDownListCancel" runat="server" CssClass="droplist">
                                        <asp:ListItem Value="--all--">--all--</asp:ListItem>
                                        <asp:ListItem Value="From system">Hệ thống</asp:ListItem>
                                        <asp:ListItem Value="From user ">SMS</asp:ListItem>
                                        <asp:ListItem Value="From editor">Tool</asp:ListItem>
                                    </asp:DropDownList>
                            </td>
                            <td align="right">
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="KÊNH ĐĂNG KÝ">
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="vRegistration_Channel" runat="server" CssClass="label"> <%# DataBinder.Eval(Container.DataItem, "vRegistration_Channel")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
