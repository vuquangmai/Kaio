<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2OnlineMTLogerVMS8979.aspx.vb" Inherits="Prjs.Portal.Report.S2OnlineMTLogerVMS8979" %>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="DropDownListStatus" runat="server" CssClass="droplist">
                                    ...
                                    <asp:ListItem>DeliveredToTerminal</asp:ListItem>
                                    <asp:ListItem>DeliveryImpossible</asp:ListItem>
                                    <asp:ListItem>DeliveredToNetwork</asp:ListItem>
                                    <asp:ListItem>DeliveryUncertain</asp:ListItem>
                                    <asp:ListItem>MessageWaiting</asp:ListItem>
                                </asp:DropDownList>
