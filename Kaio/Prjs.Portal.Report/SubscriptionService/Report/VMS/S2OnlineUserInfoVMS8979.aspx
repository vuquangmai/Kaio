<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2OnlineUserInfoVMS8979.aspx.vb" Inherits="Prjs.Portal.Report.S2OnlineUserInfoVMS8979" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="THỜI GIAN MT">
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="Requesttime" runat="server" CssClass="label">     <%# DateTime.Parse(DataBinder.Eval(Container, "DataItem.Requesttime")).ToString("dd/MM/yyyy HH:mm:ss")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
