<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2CancelUserVNM1119.aspx.vb" Inherits="Prjs.Portal.Report.S2CancelUserVNM1119" %>
                    ...
                    <table width="100%">
                        <tr>
                            <td align="right" width="30%">
                                <asp:Label ID="lblTrang14" runat="server" CssClass="label">Dịch vụ:</asp:Label>
                            </td>
                            <td align="left">
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="MÃ">
                                                <ItemTemplate>
                                                    <%# DataBinder.Eval(Container.DataItem, "CommandCode")%>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateColumn HeaderText="DỊCH VỤ">
                                             ...
                                             <asp:TemplateColumn HeaderText="T/G ĐĂNG KÝ">
                                                <ItemTemplate>
                                                    <%# DataBinder.Eval(Container.DataItem, "SubscriptionTime")%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateColumn>
                                                  <asp:TemplateColumn HeaderText="T/G HỦY">
                                                <ItemTemplate>
                                                    <%# DataBinder.Eval(Container.DataItem, "UnsubscriptionTime")%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateColumn>
                                       ...
                                       <asp:TemplateColumn>
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="deleter" runat="server" AlternateText="Delete" BorderStyle="None"
                                                        CausesValidation="False"  Visible= '<%#DataBinder.Eval(Container.DataItem, "IsStatus")%>' CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id")%>'
