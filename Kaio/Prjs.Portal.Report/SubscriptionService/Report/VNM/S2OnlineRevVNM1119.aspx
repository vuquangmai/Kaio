<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2OnlineRevVNM1119.aspx.vb" Inherits="Prjs.Portal.Report.S2OnlineRevVNM1119" %>
                ...
                <div class="input">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:CheckBox ID="CheckBoxKeyWord" runat="server" CssClass="checkbox" Text="Mã dịch vụ:" TextAlign="Left" />
                            </td>
                            <td align="left">


                                <asp:TextBox ID="txtKeyWord" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Font-Bold="True" ForeColor="#0033CC" Width="40%"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtUser_Id" runat="server" AutoCompleteType="Disabled" CssClass="txtContent" Font-Bold="True" ForeColor="#0033CC" Width="40%"></asp:TextBox>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="NGÀY">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="Day" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vDate")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="GIỜ">
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="Hour" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vHour")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="KHÁCH HÀNG">
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="ShortCode" runat="server" CssClass="label">   <%# DataBinder.Eval(Container.DataItem, "vUser_Id")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="DỊCH VỤ">
                            <ItemStyle Width="15%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="ServicesName" runat="server" CssClass="label"> <%# DataBinder.Eval(Container.DataItem, "vService_Name")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="MÃ DỊCH VỤ">
                            <ItemStyle Width="15%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="vSubscriptionKeyword" runat="server" CssClass="label"> <%# DataBinder.Eval(Container.DataItem, "vSubscriptionKeyword")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="ĐỐI TÁC">
                            <ItemStyle Width="15%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="vPartnerName" runat="server" CssClass="label"> <%# DataBinder.Eval(Container.DataItem, "vPartnerName")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="CDR">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Total" runat="server" CssClass="label" Font-Bold="true">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "vTotal"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="ĐƠN GIÁ">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="Charging_Price" runat="server" CssClass="label" Font-Bold="true">   <%# DataBinder.Eval(Container.DataItem, "vCharging_Price")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="VMG">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="MoneyTotalVMG" runat="server" CssClass="label" Font-Bold="true" ForeColor="Blue">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "vMoneyVMG"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="V//">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="MoneyTotalVNM" runat="server" CssClass="label" Font-Bold="true">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "vMoneyVNM"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText=" DOANH THU TỔNG">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="MoneyTotal" runat="server" CssClass="label" Font-Bold="true" ForeColor="Red">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "vMoneyTotal"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
