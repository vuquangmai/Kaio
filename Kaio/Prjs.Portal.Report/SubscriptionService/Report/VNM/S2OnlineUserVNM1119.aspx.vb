...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        sql = "SELECT  YEAR(A.SubscriptionTime) as vYear , " & _
              ...
              " (case when '" & Me.CheckBoxUser_Id.Checked & "'='False' then '--all--' else A.UserId end ) as vUser_Id, " & _
              " (case when '" & Me.CheckBoxService_Id.Checked & "'='False' then '--all--' else convert(nvarchar,B.servicename)  end ) as vService_Name,  " & _
              ...
              " FROM " & vTable & " A LEFT JOIN S2_Vnm_Services B on A.ServiceId=B.ServiceId " & _
        ...
        If Me.CheckBoxService_Id.Checked And Me.RadDropDownListService_Id.SelectedItem.Value > 0 Then
            sqlConditional = sqlConditional & " AND CONVERT(nvarchar,B.ServiceId) ='" & Me.RadDropDownListService_Id.SelectedItem.Value & "'"
        End If
        If Me.CheckBoxUser_Id.Checked = True And Me.txtUser_Id.Text.Trim <> "" Then
            sqlConditional = sqlConditional & " and CONVERT(nvarchar,A.UserId) =N'" & Me.txtUser_Id.Text.Trim & "'"
        End If
        ...
        If Me.CheckBoxService_Id.Checked Then
            sqlGroup = sqlGroup & ", CONVERT(nvarchar,B.servicename) "
        End If

        If Me.CheckBoxUser_Id.Checked Then
            sqlGroup = sqlGroup & ",  A.UserId "
        End If
