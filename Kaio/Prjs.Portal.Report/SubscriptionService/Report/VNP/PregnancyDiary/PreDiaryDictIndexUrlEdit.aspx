<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PreDiaryDictIndexUrlEdit.aspx.vb" Inherits="Prjs.Portal.Report.PreDiaryDictIndexUrlEdit" %>
                ...
                <table border="0" cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:Label ID="Label26" runat="server" CssClass="label">Gói ngày:</asp:Label>
                                    </td>
                                    <td  >
                            <asp:TextBox ID="txtRatio_Share_Diary" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                            ...
                            <asp:Label ID="Label25" runat="server" CssClass="label">%</asp:Label>
                                ...
                                <tr>
                                    <td align="right">
                            <asp:Label ID="Label27" runat="server" CssClass="label">Gói tuần:</asp:Label>
                                    </td>
                                    <td  >
                            <asp:TextBox ID="txtRatio_Share_Week" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="60px" Font-Bold="True" MaxLength="3"></asp:TextBox>
                            ...
                            <asp:Label ID="Label28" runat="server" CssClass="label">Gói Clip:</asp:Label>
                                    </td>
                            ...
                            <asp:Label ID="Label30" runat="server" CssClass="label">%</asp:Label>
                                ...
                                <tr>
                                    <td align="right" class="auto-style2">
                            <asp:Label ID="Label31" runat="server" CssClass="label">Gói Audio:</asp:Label>
                                    </td>
                                    <td class="auto-style2"  >
                            <asp:TextBox ID="txtRatio_Share_Audio" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="60px" Font-Bold="True" MaxLength="3"></asp:TextBox>
                            <asp:Label ID="Label32" runat="server" CssClass="label">%</asp:Label>
                                ...
                                <tr>
                                    <td align="right" class="auto-style2">
                            <asp:Label ID="Label33" runat="server" CssClass="label">Gói tư vấn:</asp:Label>
                                    </td>
                                    <td class="auto-style2"  >
                            <asp:TextBox ID="txtRatio_Share_Advise" runat="server" AutoCompleteType="Disabled" CssClass="txtContent"
                                Width="60px" Font-Bold="True" MaxLength="3"></asp:TextBox>
