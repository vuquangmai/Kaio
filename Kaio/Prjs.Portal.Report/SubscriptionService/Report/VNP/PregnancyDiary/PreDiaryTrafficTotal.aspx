<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PreDiaryTrafficTotal.aspx.vb" Inherits="Prjs.Portal.Report.PreDiaryTrafficTotal" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function IsDetail(contract_code, year, month) {
            window.open("../DictIndex/PreDiaryContractInfo.aspx?objid=" + contract_code + "&year=" + year + "&month=" + month, "Bil_Vishare_Info", "location=no,directories=no,left=0,top=0,height=900,width=1000,status=no,scrollbars=yes,toolbars=no,menubar=no,resizable=yes");
        }
    </script>
    <style type="text/css">
        fieldset {
            display: block;
            border: 1px solid #BCDDAF;6
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <telerik:RadComboBox ID="RadDropPackage_Text" runat="server" CheckBoxes="True" EnableCheckAllItemsCheckBox="True" Skin="Hay" Width="150px">
                                                <Items>
                                                    <telerik:RadComboBoxItem runat="server" Text="NGÀY" Value="NGÀY" />
                                                    <telerik:RadComboBoxItem runat="server" Text="TUẦN" Value="TUẦN" />
                                                    <telerik:RadComboBoxItem runat="server" Text="CLIP" Value="CLIP" />
                                                    <telerik:RadComboBoxItem runat="server" Text="AUDIO" Value="4" />
                                                    <telerik:RadComboBoxItem runat="server" Text="TƯ VẤN" Value="5" />
                                                </Items>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="VMG SAU TELCO">
                            ...
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="Total_Money_VMG_Partner" runat="server" CssClass="label" Font-Bold="true" ForeColor="Red">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Total_Money_VMG_Partner"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="VMG SAU ĐỐI TÁC">
                            <ItemStyle Width="5%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="Total_Money_Partner_VMG" runat="server" CssClass="label" Font-Bold="true" ForeColor="Blue">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "Total_Money_Partner_VMG"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
