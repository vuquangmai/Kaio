                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                              ...
                              <asp:DropDownList ID="DropDownListPrice_Unit" runat="server" CssClass="droplist">
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="DỊCH VỤ">
                            ...
                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Label ID="lblvMT_Price" runat="server" CssClass="label"> <%# DataBinder.Eval(Container.DataItem, "vMT_Price")%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
