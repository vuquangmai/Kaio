<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="S2OnlineRevVNP8979.aspx.vb" Inherits="Prjs.Portal.Report.S2OnlineRevVNP8979" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="VNP">
                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblvMoneyViolet" runat="server" CssClass="label" Font-Bold="true">   <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "vMoneyTelcos"), 0)%></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
