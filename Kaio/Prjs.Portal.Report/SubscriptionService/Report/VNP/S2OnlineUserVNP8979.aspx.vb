...
Public Class S2OnlineUserVNP8979
    Inherits GlobalPage
...
#Region "Page load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO ĐĂNG KÝ, HỦY DỊCH VỤ 8979 - VINAPHONE"
            BindDictIndex()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim vTable As String = "S2_GPC_TTND_RegisteredUsers"
        ...
        sql = "SELECT  YEAR(A." & vParaTime & ") as vYear , " & _
              ...
              " FROM " & vTable & " A INNER JOIN S2_GPC_TTND_Services B on A.Service_ID=B.Service_ID " & _
