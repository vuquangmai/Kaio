<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ViSportLogChargeUserVNM.aspx.vb" Inherits="Prjs.Portal.Report.ViSportLogChargeUserVNM" %>
                    ...
                    <ItemStyle CssClass="datagridItemStyle" />
                      <Columns>
                                            <asp:TemplateColumn>
                                               ...
                                               <asp:TemplateColumn HeaderText="GIÁ TIỀN">
                                                <ItemTemplate>
                                                    <%# DataBinder.Eval(Container.DataItem, "Price")%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="8%" />
                                            </asp:TemplateColumn>
                                            <asp:TemplateColumn HeaderText="THỜI GIAN TRỪ TIỀN">
                                                <ItemTemplate>
                                                    <%# DataBinder.Eval(Container.DataItem, "ChargingDate")%>
                                                </ItemTemplate>
