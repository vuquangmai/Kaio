<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ViSportMTLogVNM.aspx.vb" Inherits="Prjs.Portal.Report.ViSportMTLogVNM" %>
                    ...
                    <ItemStyle CssClass="datagridItemStyle" />
                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="THỜI GIAN">
                                                <ItemTemplate>
                                                       <%# DateTime.Parse(DataBinder.Eval(Container.DataItem, "ResponseTime")).ToString("dd-MM-yyyy HH:mm:ss")%>
                                                </ItemTemplate>
