...
#Region "Page load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO LOG GIAO DỊCH MT DỊCH VỤ VISPORT - V//"
            BindDictIndex()
            InitData()
        End If
    End Sub
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        Dim vTable As String = "Sport_Game_Hero_SMS_MT"
        ...
        sqlOrder = " Order by ResponseTime "
        sql = "SELECT  A.* , " & _
                 " row_number() over( Order by ResponseTime desc) as RowNumber " & _
                 " FROM " & vTable & " A"
        ...
        If Me.CheckBoxAllDate.Checked = False Then
            sqlConditional = sqlConditional & " AND CONVERT(varchar, ResponseTime,112) >=" & vFromDate & " AND CONVERT(varchar, ResponseTime,112)<=" & vToDate
        End If
