<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ViSportRevVNM.aspx.vb" Inherits="Prjs.Portal.Report.ViSportRevVNM" %>
        ...
        <div id="HQ">
            ...
            <div class="input">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtKeyword" runat="server" CssClass="txtContent" Width="80%"></asp:TextBox>
                        </td>
                        <td align="right">
            ...
            <div class="datagrid">
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AutoGenerateColumns="false"
                    ...
                    PagerStyle-Mode="NextPrev" PagerStyle-Visible="true" PageSize="120"
                    Width="100%">
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblOrder" runat="server" Font-Names="Tahoma" Font-Size="8pt"
                                    ForeColor="DimGray" Text="<%# Container.ItemIndex+1 %>"> </asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateColumn HeaderText="GIÁ">
                            <ItemTemplate>
                                <asp:Label ID="Price" runat="server" Font-Bold="true">         <%#  DataBinder.Eval(Container.DataItem, "Price") %></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="VMG">
                            <ItemTemplate>
                                <asp:Label ID="lbltotalMoneyVMG0" runat="server" Font-Bold="true"
                                    ForeColor="Blue">         <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "MoneyTotalVMG"), 0)%></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="VNM">
                            <ItemTemplate>
                                <asp:Label ID="lbltotalMoneyVNM" runat="server" Font-Bold="true"
                                    ForeColor="red">         <%# Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "MoneyTotalVNM"), 0)%></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="TỔNG">
                            <ItemTemplate>
                                <asp:Label ID="lblvMoney" runat="server" Font-Bold="true">         <%#Utils.FormatDecimal(DataBinder.Eval(Container.DataItem, "MoneyTotal"), 0)%></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                        </asp:TemplateColumn>
                    </Columns>
                    <PagerStyle HorizontalAlign="Right" NextPageText="" PageButtonCount="5"
