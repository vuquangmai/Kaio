<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Viettel8x62InactiveUsers.aspx.vb" Inherits="Prjs.Portal.Report.Viettel8x62InactiveUsers" %>
                ...
                <asp:DataGrid ID="DataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                    ...
                    <Columns>
                       ...
                       <asp:TemplateColumn HeaderText="T/G HỦY">
                            <ItemStyle Width="15%" HorizontalAlign="Center" />
                            <ItemTemplate>
                                   <asp:Label ID="lblCancelTime" runat="server" CssClass="label"> <%# DateTime.Parse(DataBinder.Eval(Container.DataItem, "CancelTime")).ToString("dd-MM-yyyy hh:mm:ss")%> </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
