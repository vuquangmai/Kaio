...
Public Class Viettel8x62RegisteredUsers
    Inherits GlobalPage
...
#Region "Page load"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            Me.lbltitle.Text = "BÁO CÁO ĐĂNG KÝ DỊCH VỤ 8x62"
            BindDictIndex()
            InitData()
...
#Region "Bind Data"
    Private Sub BindData(ByVal intPageSize As Integer, ByVal intCurentPage As Integer, ByVal strAction As String)
        ...
        Dim vTable As String = "p8x62_Registered_Users"
        ...
        sql = "SELECT A.User_ID,A.Request_ID,A.Short_Code,A.Command_Code,A.RegisteredTime,A.Registration_Channel,B.Service_Name, " & _
                              " row_number() over( Order by A.RegisteredTime ) as RowNumber " & _
                              " From " & vTable & " A " & _
